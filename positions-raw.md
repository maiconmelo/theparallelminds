...
**Location:** Remote from anywhere in the EU

**Total compensation:** up to 250k TC

Join an AI infrastructure team building the GPU, networking, and storage platforms underneath large-scale AI training workloads. This role focuseson the quality, scalability, reliability, and efficiency of the infrastructure before workloads arrive.
...
## 2. HPC Infrastructure & Scheduler Engineer (PBS Professional)

**Location:** Remote with some travel required to either Stockholm or Gothenburg
...
- Mais de 10 anos de experiência profissional com Linux
- Bachelor's Degree

---

## 4. HPC Infrastructure Technician

**📍 Germany / Northern Europe / Slovenia / Poland**
**💰 30€/h**
**⏰ Full-time**

**What we need:**
- Hardware installation of servers & network equipment
- Solid HPC / cluster / compute environment experience
- Physical resilience for data center work
- Basic Linux/Unix knowledge is a plus
- Good English

**What you get:**
- Stable, long-term project engagement
- Competitive rate
- No micromanagement

---

## 5. HPC Systems Engineer (3-7 years)

**#Hiring #HPC #SystemsEngineer (3--7 years)**

Looking for professionals experienced in managing and optimizing HPC environments.

**Key areas:**
- Linux administration & HPC architecture
- SLURM / PBS schedulers
- Job failure analysis & performance tuning
- MPI / OpenMP
- Storage: Lustre, NFS, GPFS
- Networking: InfiniBand preferred
- Scripting: Python / Bash
- AWS ParallelCluster / PCS is a plus

---

## 6. Senior HPC Engineer (Infrastructure)

**📍 Location: Riyadh,SA | 💼 10+ Years**

Looking for a highly skilled HPC Engineer with strong hands-on experience in:
- ✔️ NVIDIA AI Stack (BCM, GPU Operator, NIMs, Blueprints)
- ✔️ Kubernetes (CKA) & Slurm
- ✔️ Linux (RHEL / Ubuntu)
- ✔️ CI/CD & HPC Cluster Management

**🎓 RHCE & CKA required**

**📩 Apply now: dinesh.g@nygci.com**

---

## 7. HPC Engineer - Harvard Medical School

Harvard Medical School is seeking a High-Performance Computing (HPC) Engineer to join our HPC Team. This role is critical in supporting cutting-edge biomedical research through the design and maintenance of large-scale Linux environments.

**The Ideal Candidate:**
- **Linux Expert:** Possesses good knowledge of the Linux OS and a proven track record of troubleshooting complex kernel, network, process, and file system issues.
- **Automation Specialist:** Skilled in Infrastructure as Code (IaC) using Ansible to manage and scale cluster configurations.
- **HPC Architecture:** Experienced with Slurm or similar workload managers to optimize job scheduling and resource allocation.
- **Advanced Hardware:** Familiarity with NVIDIA Base Command Manager (BCM) and GPU-accelerated computing is highly desirable.

Join a team where your technical expertise directly enables scientific breakthroughs.

**This is not a 100% remote position, you must be legally authorized to work in the United States.**

---

## 8. High Performance Computing (HPC) Engineer - Singapore

**📍 Location: Singapore**
**💼 Experience: 5+ Years**
**🏢 Work Mode: Hybrid / Onsite**

We are looking for an experienced HPC Engineer to manage and optimize High Performance Computing environments supporting advanced research and enterprise workloads.

**🔧 Key Responsibilities:**
- Manage HPC clusters and scheduling systems
- Support GPU computing environments (NVIDIA / CUDA / ROCm)
- Cluster monitoring, performance tuning & troubleshooting
- Linux administration and automation
- Storage and virtualization management
- Cloud provisioning (AWS / Azure / GCP)
- MLOps / AI workload enablement
- Infrastructure as Code using Terraform / Ansible

**🛠 Required Skills:**
- PBS Professional / SLURM
- Red Hat Linux
- Bright Cluster Manager / xCAT / Puppet
- InfiniBand / Ethernet networking
- NVIDIA GPU, CUDA, ROCm, OpenCL
...
## 9. HPC Engineer (4-6 Years) - Bangalore

**🔹 Role Overview**

We are looking for professionals with strong expertise in HPC architecture, performance tuning, and parallel computing to deliver real-time solutions for scientific and compute-intensive workloads.

**🔹 Key Responsibilities**
- Work on HPC, CUDA, and performance optimization projects
- Perform workload assessment, application profiling, and tuning
- Develop and optimize applications for high scalability
- Troubleshoot and resolve compiler and performance issues
- Execute HPC applications at scale using MPI and OpenMP
- Collaborate on benchmarking and performance analysis

**🔹 Required Skills**
- Strong programming skills in C/C++/Fortran
- Experience with High Performance Computing Architecture
- Hands-on experience with Linux/UNIX environments
- Scripting knowledge (Shell, Python, Perl)
- Experience with MPI and OpenMP multi-threading
- Familiarity with Intel and GNU compilers
- Understanding of x86_64 processor architecture
...
**📧 How to Apply:**
Send your updated resume to UdayaLakshmi@systechcorp.in

---

## 10. Senior HPC & GPU Infrastructure Engineer - Sciforium

**Location:** San Francisco Bay Area (Hybrid/Onsite)

Sciforium is building next-generation AI infrastructure and high-performance serving platforms for frontier-scale multimodal models, backed by AMD.

We are looking for a Senior HPC & GPU Infrastructure Engineer to lead operations, reliability, and performance across our GPU data center infrastructure and large-scale compute clusters.

The role focuses on:
- GPU cluster operations & reliability
- Linux systems engineering
- NVIDIA / AMD GPU infrastructure
- CUDA / ROCm environments
- High-performance networking & distributed systems
- AI/ML infrastructure at scale

Experience with HPC environments, GPU bring-up, Kubernetes, Slurm, RDMA/NVLink, and production infrastructure operations is highly valued.

Please reach out directly if interested.

---

## 11. HPC Cluster & Scheduler Management Consultant

**📍 Location: Remote**
**🧑‍💻 Experience Required: 12+ Years**
**📄 Work Authorization: USC / GC / GC EAD**

We are looking for an experienced HPC Cluster & Scheduler Management Consultant to join our team. The ideal candidate should have strong expertise in High Performance Computing (HPC) environments, cluster administration, and scheduler management.

**📩 If you are interested share your resume on saloni.dhawade@leanitcorp.com**

---

## 12. HPC Engineer - Remote (1 Year Experience)

**🔹 Role: HPC Engineer**
**🔹 Location: Remote**
**🔹 Experience: #1YearExperience**
**🔹 Joining: Immediate Joiners Preferred**

**Key Skills:**
- ✔ Slurm Administration & Scheduling
...
**Responsibilities:**
- Manage and support HPC clusters
- Troubleshoot system and scheduler issues
- Monitor cluster performance and availability
- Support users and optimize workloads
- Work with infrastructure teams for cluster stability

**Preferred:**
- ⭐ Experience with GPU clusters
- ⭐ Knowledge of Ansible or automation tools
- ⭐ Exposure to cloud HPC environments

**📩 Interested candidates can share their resume along with: Samreen.kh1@aptlytech.com**
- Current CTC
- Expected CTC
- Notice Period
- Current Location
...
## 13. HPC Linux Systems Engineer, Classified Environment - Oak Ridge National Laboratory
...
## 14. Project Director -- HPC / AI Infrastructure Deployment
...
- Ensure optimized thermal management (liquid cooling, rear door heat exchangers, immersion cooling where applicable)
...
## 15. HPC, Cloud & Infrastructure Engineering Roles - Dallas, TX

**🚀 We're Hiring | HPC, Cloud & Infrastructure Engineering Roles | Dallas, TX**

Join a high-performance engineering organization building next-generation HPC, Kubernetes, Cloud, Security, Storage, and AI-driven infrastructure platforms.
...
- 🔹 Technical Assistant / PM -- Office of COO

**📍 Location: Dallas, TX**
**🌐 Some positions may support Remote/Hybrid flexibility**
...
- ✔ Storage Platforms (Lustre, GPFS, BeeGFS)
- ✔ Networking, VPNs & Zero Trust Security
- ✔ Prometheus, Grafana & Observability Tools

**🎯 We're looking for professionals with strong experience in:**
- Distributed Systems
- HPC Infrastructure
...
**📧 Interested candidates can send resumes to: saibhaskar@techmindsinc.com**

---

## 16. HPC / C++ Developer - Bangalore

**📌 Role: HPC / C++ Developer**
...
**🔹 Job Highlights:**
- ✅ Hands-on experience in HPC scientific applications
- ✅ Application profiling & workload assessment
- ✅ Performance optimization at scale
- ✅ Strong understanding of x86_64 processor architecture
- ✅ Expertise in Linux environments and multi-threading

**📩 Interested candidates can share their updated resume to: [Contact information not provided in the original posting]**

---

## 17. Technical Leader -- HPC & Simulation Environments (German Speaking)

**Location: Pune, India**
**Experience: 10+ Years**

We are seeking an experienced Technical Leader -- HPC & Simulation Environments to drive the strategy, architecture, and evolution of our complex simulation ecosystem. This role requires a recognized technical expert who can shape and optimize HPC environments across compute, storage, client/VDI, monitoring, and emerging technologies such as AI and data analytics.

**Key Responsibilities**
- Serve as the technical authority and thought leader for HPC and simulation environments.
- Define and drive architecture and roadmap for HPC compute, storage, networking, VDI, and monitoring platforms.
- Lead the adoption of emerging technologies, including AI/ML and data analytics solutions.
- Collaborate with engineering, research, and business teams to support high-performance simulation workloads.
- Drive performance optimization, automation, scalability, and operational excellence initiatives.
- Mentor technical teams and influence strategic technology decisions.

**Required Skills & Experience**
- 10+ years of experience in HPC, infrastructure architecture, or simulation environments.
- Strong expertise in Linux, HPC clusters, storage systems, high-speed networking, job schedulers (e.g., Slurm, PBS, LSF), and VDI technologies.
- Experience with cloud platforms, automation, and infrastructure modernization.
- Exposure to AI/ML infrastructure and data analytics platforms is highly desirable.
- Strong leadership, stakeholder management, and problem-solving skills.
- Fluent German and English communication skills are mandatory.

---

## 18. HPC & AI Infrastructure Solution Architect - India

**📍 India | 💼 8--10+ Years**

**🔹 Key Skills**
- 🖥️ HPC: Slurm, PBS Pro, HPCM, NVIDIA Base Command Manager
- ⚡ Networking: InfiniBand, Mellanox, High-Speed Ethernet
- 📦 Containers: Docker, Podman, Singularity
- ☸️ Platforms: Kubernetes, OpenShift, Rancher, Charmed Kubernetes
- 🎮 GPU: NVIDIA GPU Operator, DCGM
- 🐧 Linux: RHEL, SLES, Ubuntu
- 🖧 Virtualization: KVM, OpenShift Virtualization
- ☁️ Cloud & DevOps: Hybrid Cloud, CI/CD, IaC, MLOps
- ⚙️ Automation: Python, Bash
- 🌐 Protocols: DNS, TCP/IP, S3, NFS, SMB/CIFS

**🔹 What We're Looking For**
- ✅ Strong HPC & AI infrastructure architecture experience
- ✅ Expertise in container platforms and GPU-accelerated environments
- ✅ Hybrid cloud, automation, and AI/ML platform deployment experience
- ✅ Ability to lead solution design and customer engagements

**🎓 Preferred:**
- RHCE, CKA/CKAD/CKS, NVIDIA AI Certifications

**📍 Location: Electronic City, Bangalore (WFO) | 💼 Experience: 15+ Years | ⚡ Immediate to Short Joiners Preferred**

---

## 19. HPC Engineer (AI Infrastructure) - US-based, Remote

**Salary: $190K + Bonus + Equity**

My client is a fast-growing GPU cloud provider running large-scale, bare-metal GPU datacenters for customers training and serving AI at the frontier. They need an HPC specialist to own performance across their clusters as they scale.

**Role Overview:**
- → Owning Slurm scheduling and resource management across thousands of GPUs (H100s, B200s)
- → Optimising NCCL, multi-node interconnect, and GPU-to-GPU performance over high-speed Ethernet and InfiniBand
- → Working directly with customers on distributed training bottlenecks and multi-node performance
- → Building the automation and monitoring that keeps clusters healthy as they grow

They want someone who genuinely lives in HPC, deep in Slurm, fluent in NVIDIA GPUs at scale (CUDA, NCCL, InfiniBand/RoCE). Hands-on too.

Ideal background is someone who's done this at a neocloud, hyperscaler, or large-scale GPU/HPC environment.

Drop me a message if you're interested 🙂

---

## 20. HPC Systems Engineer - Chennai
...
- Diagnose and resolve HPC issues (HPC applications, scheduler, storage). Analyze job failures, performance bottlenecks, and system logs.
...
**📩 Share profile to nanda@sridsoftware.com**

---

## 21. Senior Solutions Architect - NVIDIA (Europe)
...
## 22. Systems Engineers / System Administrators - Mistral AI
...
## 23. HPC Architect - Applied Materials

**Job Title: HPC Architect**
**Location: Bangalore**

**About Applied:** Applied Materials is the leader in materials engineering solutions used to produce virtually every new chip and advanced display in the world.

**About PDC:** Applied Materials SW & AI Group leads the development of image processing systems, which are integrated in a wide range of products. These highly distributed systems capture the images from high-speed scanning systems and perform complex image processing algorithms to detect defects on memories and processors chips.

**Role Description:**
As a Senior Software Architect, you will be responsible for designing and implementing complex software solutions for our organization. You will work closely with cross-functional teams, including software engineers, product managers, and business stakeholders, to understand requirements and translate them into architectural designs that meet business needs. Your primary focus will be on ensuring that the software systems are scalable, reliable, and maintainable.

**Key Responsibilities:**
- Architect and design software solutions that align with business goals and technical requirements.
- Collaborate with cross-functional teams to understand business needs and translate them into architectural designs.
- Develop and maintain architectural guidelines, standards, and best practice
...
**Requirements:**
- 12-15 yrs. of experience with B. Tech / MTech /Ph. d in Electronics / Computer Science
...
- Practical Experience with GPU/CPU Optimization techniques like Overclocking/Memory Optimization/Load Balancing/Hyperthreading/Simultaneous multithreading (SMT).

**Advantage:**
- Knowledge on Semiconductor domain.
...
- Bachelor's degree in Computer Science, Software Engineering, or related field (or equivalent field).
...
## 27. Principal HPC Architect - KLA
...
## 28. Senior HPC Architect - NVIDIA
...
## 29. HPC Engineer - Honeywell

**Job Description**

As an HPC Engineer at Honeywell, you will design, deploy, and maintain high-performance computing environments that power advanced data processing and computational workloads. This role is critical in ensuring our infrastructure delivers maximum performance, scalability, and reliability to support innovation across engineering and research teams. Working closely with cross-functional stakeholders, you will optimize HPC systems and enable faster, more efficient data analysis that drives operational excellence and business impact.

You will report directly to our IT Infrastructure Manager and you'll work out of our Bucharest, RO location on a Hybrid work schedule (3 + 2).

**Key Responsibilities**
- Design, implement, and manage HPC clusters and supporting infrastructure
- Deploy, maintain, and provide ongoing support for high-performance computing environments
- Optimize system performance, scalability, and reliability through configuration tuning and monitoring
- Collaborate with engineering and research teams to understand computational needs and provide technical solutions
- Manage job scheduling systems (e.g., Slurm, PBS) and cluster tools
- Ensure efficient storage and networking performance within HPC environments
- Troubleshoot system issues and ensure high availability of services

**Requirements**
- 3+ years of experience working with HPC systems, cluster management, and parallel computing environments
- Bachelor's degree in a technical field (e.g., Computer Science, Engineering, Mathematics, or similar)
- Strong knowledge of HPC architecture and job schedulers (e.g., Slurm, PBS)
- Hands-on experience with Linux/Unix systems and strong Linux administration skills
- Experience with scripting (Python, Bash) and performance tuning
- Experience managing storage in HPC environments
- Solid understanding of networking and storage technologies relevant to HPC

**Nice-to-Have Skills**
- Advanced degree in Computer Science, Engineering, or related field
- Experience with hybrid or cloud-based HPC solutions
- Familiarity with containerization technologies (Docker, Kubernetes)
- Knowledge of parallel programming models (MPI, OpenMP)
- Strong problem-solving mindset and ability to collaborate cross-functionally

---

## 30. HPC Engineer - Amentum

Amentum is currently seeking an experienced High Performance Computing (HPC) Engineer experienced in supporting Linux environments to work supporting a High-Performance Computing environment. You will be a key contributor in supporting and evolving our high-performance computing infrastructure.
...
- Write and update documentation for end users and system administrators.
- Assist in the design and implementation of new HPC systems.

**Here's What You'll Need:**
- Bachelor's degree in Computer Science, Engineering, Physics, or a related technical field.
- At least 3 years' experience working on Linux IT related systems.
...
## 31. HPC Engineer - Formula 1 Team

We are looking for a talented HPC Engineer to help push the boundaries of simulation, aerodynamics, and data-driven decision-making. If you thrive in high-pressure environments, love solving complex computational challenges, and want your work to directly influence on-track results, this is your opportunity.

- Develop, maintain, and optimise the team's High-Performance Computing infrastructure to support CFD, simulation, and analytics workloads.
- Collaborate closely with Aerodynamics, CFD, and Software Engineering departments to ensure seamless workflow execution.
- Benchmark, tune, and troubleshoot performance issues across clusters, schedulers, interconnects, storage, and compute nodes.
- Support the deployment and scaling of engineering applications, including CFD solvers and data-processing tool chains.
- Implement monitoring, alerting, and automation to enhance reliability and efficiency.
- Contribute to long-term HPC roadmap planning, including hardware refresh cycles and architectural improvements.

**Requirements**

*What do we need from you?*
- Proven experience in HPC system administration or engineering within scientific, automotive, aerospace, or similar high-performance environments.
- Strong knowledge of Linux systems, cluster management, job schedulers (e.g., Slurm, PBS, LSF), and parallel computing.
- Experience with profiling, optimisation, and troubleshooting MPI/OpenMP-based applications.
- Familiarity with HPC networking, storage, security, and performance tuning.
- Proficiency in scripting languages (Python, Bash, etc.).
- Excellent problem-solving skills and ability to work effectively in a fast-paced, mission-critical environment.

*Desirable*
- Experience using or supporting large-scale HPC environments.
- Knowledge of CFD workflows, meshing strategies, and solver tuning.
- Cloud-based HPC experience.
- Exposure to containerisation (Singularity/Apptainer, Docker) or orchestration technologies.
- Experience optimising workloads on GPU-accelerated systems.

---

## 32. HPC Engineer - GBI (Genomics)
...
## 33. Senior HPC Engineer - ASRC Federal
...
## 34. Junior HPC Engineer - Italy

**Posizione: Junior HPC Engineer**

La risorsa entrerà a far parte del team infrastrutturale HPC e collaborerà alla gestione e ottimizzazione di ambienti HPC dedicati a simulazioni, calcolo scientifico, AI/ML e workload ad alte prestazioni.

**Attività principali**
- Supportare la gestione e il monitoraggio di infrastrutture HPC on-premise e cloud
- Collaborare all'installazione, configurazione e manutenzione di cluster Linux
- Supportare attività di troubleshooting sistemistico e performance tuning
- Gestire job scheduler e ambienti di calcolo distribuito
- Collaborare con team AI e engineering per ottimizzare workload computazionali
- Supportare attività di automazione infrastrutturale e scripting
- Partecipare all'evoluzione delle architetture HPC e AI Infrastructure
- Redigere documentazione tecnica e procedure operative

**Requisiti:**

*Competenze tecniche di base*
- Conoscenza di sistemi operativi Linux
- Familiarità con networking TCP/IP e infrastrutture IT
- Conoscenza di ambienti virtualizzati e/o containerizzati
- Capacità di scripting (Bash, Python o simili)
- Interesse verso infrastrutture HPC, AI Infrastructure e sistemi distribuiti

*Costituiscono titolo preferenziale*
- Conoscenza di scheduler HPC (Slurm, PBS, LSF)
- Esperienza universitaria o personale con cluster Linux
- Familiarità con GPU computing (NVIDIA CUDA)
- Conoscenza di ambienti cloud (Azure, AWS, GCP)
- Conoscenza di tecnologie container (Docker, Kubernetes)
- Interesse verso AI/ML infrastructure e calcolo scientifico

*Soft Skills*
- Attitudine al problem solving
- Curiosità tecnologica e volontà di apprendimento continuo
...
*Cosa offriamo*
- Percorso di crescita tecnica su tecnologie HPC, AI e infrastrutture avanzate
- Coinvolgimento in progetti innovativi e multidisciplinari
- Formazione continua e certificazioni
- Ambiente dinamico e orientato all'innovazione
- Collaborazione con vendor tecnologici leader di mercato

---

## 35. Senior HPC Engineer (Classified) - ORNL
...
InfiniBand RoCEv2、GPUDirect RDMA、GPUDirect Storage、NCCL、CUDA 驱动及 OFED。
...
Lustre、BeeGFS、WEKA、VAST、DDN/ExaScaler 等。
...
**The base salary range for this role is £79,000 to £105,000.**

---

## 39. HPC Platform Engineer - Lilly

The Cloud and Connectivity organization is seeking an HPC Platform Engineer. This role will focus on enabling analytical, statistical, and scientific computing capabilities within Lilly's high performance computing infrastructure. We are looking for an HPC Platform Engineer to help accelerate the next era of high performance computing innovation.

**What You'll Be Doing**
- You will be a leader the engineering and operations of design, build, and maintain scalable HPC platforms.
- You will play a crucial role in enabling Lilly's HPC infrastructure and experiences.
...
**How You'll Succeed**
- Be Bold - You will bring a high learning agility and platform engineering skills to enable the Lilly Technology strategy, identifying opportunities to accelerate our HPC journey.
...
- Be Your Best - You will learn about new technologies in HPC.
...
- 5+ years' experience as an HPC Platform Engineer.

---

## 40. High Performance Compute (HPC) Engineer - TENICA

TENICA is looking to hire High Performance Compute (HPC) engineer
...
- Deliver deep technological solutions and support related to some of Rescale's most powerful features.
...
**What we're looking for:**
- 5+ years experience with HPC Systems and HPC Applications
  ...
  - High-level knowledge of HPC, schedulers, MPI, containers, kubernetes, and GPU computing
  - Familiarity with scientific computing libraries and tools like OpenMP and CUDA
- Experience applying AI-assisted workflows as part of the software development lifecycle --- using AI agents, code generation, and automation as multipliers for engineering velocity and quality
- General knowledge in at least one CAE discipline (CFD, FEA, EDA, ML/AI, Molecular Dynamics, Weather Forecasting, Optics, etc.)
- Experience working with diverse stakeholders across IT, engineering, and R&D
- A self-starter with a proven track record of driving project success and aligning in complex cross-team environments
- Technical aptitude to deeply understand the product and platform experience and customer journey within the high-performance computing and enterprise PaaS environment
...
## 42. Senior AI/HPC Engineer - NVIDIA
...
- Knowledge and experience with AI Factory / HPC, including Linux System Administration, process management, task scheduling, kernel management, boot procedures, troubleshooting, performance reporting, and optimization.
...
- Strong organizational skills and ability to prioritize/multitask easily with limited supervision.
...
## 43. Senior Infrastructure HPC Engineer
...
## 44. HPC Engineer - AI Infrastructure (GPU Cloud)

**To $190,000 + 25% Bonus + RSUs**
**Location: Remote (US)**

**About the role**

I'm partnering with a fast-growing GPU cloud provider hiring an HPC Engineer to be their in-house subject matter expert on high-performance computing. You'll own the performance of large-scale GPU clusters running into the thousands of GPUs making sure customers doing distributed training, fine-tuning and inference get the most out of the hardware.

**What you'll do**
- Architect, deploy and manage HPC job scheduling and resource management (primarily Slurm) across large GPU clusters (H100, B200)
- Optimise NCCL configuration, collective communication patterns and multi-node interconnect performance across high-speed Ethernet and InfiniBand
- Design cluster provisioning and management workflows for GPU nodes driver stacks, CUDA toolkits, container runtimes (Enroot, Pyxis, Singularity)
- Build monitoring and profiling for HPC workloads: GPU utilisation, memory bandwidth, interconnect throughput, job performance analytics
- Work with customers and internal teams to troubleshoot distributed training issues, performance bottlenecks and multi-node communication failures
- Evaluate and support HPC ecosystem tooling including MPI implementations, NVIDIA DCGM, NVSMI and container-native HPC platforms
- Automate cluster health checks, GPU validation and large-scale burn-in
- Take part in on-call rotations, incident response and the broader engineering work needed to keep the platform running and improving
- Support customers directly with technical consultation, troubleshooting and onboarding
- Write documentation, runbooks and best practices for HPC operations and onboarding

**What they're looking for**
- 5+ years in HPC operations, GPU cluster management or high-performance infrastructure engineering
- Deep hands-on Slurm experience (installation, configuration, scheduling policies, accounting, multi-cluster federation)
- Strong understanding of NCCL, collective operations (all-reduce, all-gather) and GPU-to-GPU communication topologies
- Experience managing NVIDIA GPU infrastructure at scale: driver lifecycle, CUDA, cuDNN, TensorRT, DCGM
...
- Familiarity with high-performance networking: lossless Ethernet (RoCE), InfiniBand, GPUDirect RDMA, adaptive routing
- Linux systems expertise including kernel tuning for HPC (hugepages, NUMA, CPU pinning, IRQ affinity)

**Nice to have**
- AI/ML training frameworks at scale (PyTorch DDP, DeepSpeed, Megatron-LM, JAX)
- Parallel filesystems (Lustre, GPFS/Spectrum Scale, BeeGFS)
- Kubernetes-based HPC platforms (Volcano, Run:AI, KubeFlow)
- NVIDIA Base Command Manager, Bright Cluster Manager or similar
- HPC benchmarking (HPL, NCCL-tests, MLPerf)

---

## 45. HPC Engineer -- Elite HFT Firm -- Dubai

**Up to $275,000 Tax-Free Total Compensation**

I'm working with an elite HFT firm in Dubai hiring a strong HPC Engineer to join their infrastructure team.
- One of the most technically sophisticated trading environments in the region
- Small, high-calibre engineering team --- real ownership, serious problems

They need a strong HPC engineer to own and evolve the compute infrastructure that powers their trading operation.

**What you'll be working on:**
- Designing and scaling high-performance compute infrastructure supporting live trading systems
- Optimising CPU, memory, and network performance across a latency-sensitive environment
- Managing and evolving GPU and parallel compute resources for research and trading workloads
- Building and automating tooling to monitor, tune, and maintain HPC systems at scale
- Collaborating directly with trading and engineering teams --- your work has a direct line to performance

**What they're looking for:**
- Strong HPC engineering background --- you've designed and owned these environments at scale
- Deep Linux expertise and low-level systems knowledge
- Experience with performance profiling, tuning, and optimisation across compute and networking
- Scripting proficiency in Python or Bash for automation and tooling
- HFT, quant finance, or similarly demanding environment experience a strong plus

**What's on offer:**
- Up to $250,000 fully tax-free total compensation
- Relocation support to Dubai
- Lean, meritocratic culture --- real ownership, no corporate overhead
- Direct impact on mission-critical trading infrastructure from day one

---

## 46. Senior HPC Engineer - Texas A&M University

**Job Title:** Senior HPC Engineer
**Agency:** Texas A&M University
**Department:** Technology Services - IT Enterprise Operations
**Proposed Minimum Salary:** $11,666.67 monthly
...
We are making a bold leap into the future of artificial intelligence with a $45 million investment in an NVIDIA DGX SuperPOD. This investment underscores our commitment to all Texas A&M System members' faculty and staff providing cutting-edge research and super computing needs. As a Senior High Performance Computing Engineer (HPC), you will provide technical expertise and consultation for the design and deployment of HPC systems. Get in on the ground floor with a team that is shaping the next generation of innovation.
...
*Citizenship*: Must be a United States citizen, permanent resident, or a person granted asylum or refugee status in accordance with 15 CFR, Part 762; 22 CFR
- 122.5, 123.22 and 123.26; and 31 CFR
- 501.601
...
- All tasks and job responsibilities must be performed safely without injury to self or others in compliance with System and University safety requirements. This position is security sensitive.

---

## 47. Staff HPC Engineer
...
## 48. High Performance Computer Engineer - GovCIO (HHS)
...
**Posted Salary Range: USD $150,000.00 - USD $190,000.00 /Yr.**

---

## 49. Lead Systems HPC Engineer
...
**Compensation:** We offer competitive salaries ranging from $170k-$300k OTE + equity based on your experience.

---

## 50. HPC Operations Engineer - Arm
...
**Requirements**
- A minimum of 14 years of experience.
- A bachelor's degree in a technical discipline such as: Engineering, Systems Engineering, Computer Science, Information Systems, Engineering Science, Engineering Management, or related field from an accredited college or university is required.
...
## 52. HPC Engineer - Dallas Forth-Worth, TX
...
We are a high-growth AI cloud service provider, delivering large-scale GPU clusters for AI training and inference. Our vertically integrated platform is underpinned by a portfolio of grid-connected land and data centers in renewable-rich regions across the U.S. and Canada. Running on 100% renewable energy, we own and operate our data centers and are at the forefront of sustainable solutions for high-performance computing. We believe progress should be responsible, sustainable, and have a positive impact on the communities we serve.

**Requirements**
- 2+ years HPC cluster ops in IOC/NOC environment (incident triage, change execution)
- Kubernetes (bare-metal a plus) -- triage workloads, cluster state
- Slurm workload manager -- job triage, queue/node health checks
- HPC monitoring/logging/runbooks
- Incident response & root cause analysis
- Post-secondary or equivalent experience
- Certifications a plus (CKA, RHCSA, ITIL, CompTIA Server+, GPU)
- Cloud platforms (AWS/Azure/GCP) integration with on-prem HPC
- HPC networking/storage (InfiniBand/Ethernet, Weka/VAST, high-throughput interconnects)

**Responsibilities**
- Tier 2 support for HPC cloud (availability, SLAs)
- Troubleshoot Kubernetes, Slurm, cluster systems
- Escalation from Tier 1; perform RCA; coordinate with Tier 3/engineering
- Maintain monitoring/alerting/observability
- Execute changes, patches, upgrades per change management
- Improve runbooks, playbooks, knowledge base
- Identify recurring issues & automation opportunities
- Support tooling integration & operational readiness for new HPC capabilities
- Mentor Tier 1 & DC Techs
- Participate in on-call rotation & major incident response

**Benefits**
- Competitive base + annual incentive + equity
- 100% company-paid medical/dental/vision for employee; 75% for dependents
- Company-paid short/long-term disability
- HSA, EAP, wellness resources
...
## 53. Senior HPC Engineer - Millennium
...
In this role, you will be part of a small, senior HPC team, taking end-to-end ownership of a significant area of the platform while collaborating closely with other subject-matter experts. You will be a systems-level engineer who is comfortable owning complex technical decisions and designing and building production infrastructure, rather than advising from the sidelines.

We aim to build infrastructure that is reliable, understandable, and adaptable, and we value engineers who care about simplicity, clarity, and maintainability as much as raw performance. We recognize that strong candidates may bring different experiences, perspectives, and working styles.
...
## 54. Senior HPC Engineer - Baylor Genetics
...
**Key Responsibilities**
- Lead the design and operation of scalable HPC infrastructure supporting bioinformatics pipelines.
- Develop and maintain production genomic analysis pipelines using Nextflow and related workflow tools.
- Oversee deployment and optimization of large-scale NGS analysis workflows.
- Establish best practices for pipeline reproducibility, containerization, and workflow management.
- Manage and mentor a team of bioinformatics engineers and computational scientists.
- Collaborate with lab directors/genomic scientists, bioinformaticians, and IT teams to gather requirements and design scalable solutions.
- Optimize pipeline performance, compute utilization, and data processing throughput.
- Ensure proper documentation, testing, and maintenance of bioinformatics software and workflows.
- Implement monitoring and operational best practices for production bioinformatics platforms.
...
**Qualifications**
- PhD in Bioinformatics, Computational Biology, Computer Science, or related field preferred; MS with extensive industry experience may be considered.
- 8+ years' experience in bioinformatics software engineering, computational genomics, or related field.
- 4+ years' experience leading or mentoring bioinformatics or software engineering teams.
- Strong experience managing High Performance Computing (HPC) environments and distributed computing systems.
- Hands-on experience with HPC workload schedulers such as Slurm or similar cluster resource managers.
- Deep experience developing scalable workflow pipelines using Nextflow or similar workflow frameworks.
- Strong programming skills in Python, Bash, and/or R.
- Strong Linux/Unix system experience including cluster-based computing environments.
- Experience with containerization technologies such as Docker and Apptainer (Singularity).
- Experience implementing reproducible pipeline environments using container-based deployment.
- Experience with CI/CD practices, version control (Git), and automated testing.
- Experience supporting large-scale genomics datasets including WGS, WES, RNA-seq, or multi-omics pipelines.
- Experience with cloud computing platforms such as Azure or AWS is strongly preferred.
- Strong written and verbal communication skills and ability to collaborate across interdisciplinary teams.
...
Por eso, si tienes experiencia en HPC, soluciones de alto rendimiento etc. nos comprometemos a potenciar tu talento, impulsar tu desarrollo profesional y hacerte sentir como en casa. Si te motiva trabajar en la evolución y análisis de nuevas arquitecturas de computación acelerada (GPU, HPC, AI factories) y colaborar con equipos técnicos en entornos innovadores para definir soluciones diferenciales, queremos conocerte.

Si además disfrutas participando en entornos en constante evolución, este reto es para ti. ¿Te unes a nuestro #WelcomeHome? ¡Sigue leyendo! 🚀

**¿Qué buscamos?**
- Experiencia en segmentación multi-tenant de infraestructura (cómputo, almacenamiento, red y seguridad), incluyendo entornos IaaS, virtualización, contenedores, SDN y microsegmentación.
- Experiencia con plataformas de contenedores empresariales (por ejemplo Kubernetes/OpenShift) con aceleración GPU, RDMA, SR-IOV y capacidades multi-tenant.
- Experiencia en virtualización avanzada para IA, incluyendo GPU Passthrough, NVIDIA vGPU/MIG, NUMA-aware scheduling y confidential computing.
- Experiencia con orquestación HPC y planificación de trabajos de IA, incluyendo Slurm o equivalentes, con scheduling GPU-aware y topology-aware.

---

## 56. HPC Technologist - Hybrid HPC Environment

We're looking for an experienced High Performance Computing (HPC) Technologist who wants to design, operate, and evolve a cutting-edge hybrid HPC environment to power research and teaching - guiding and inspiring researchers in HPC concepts, technologies, and applications.

**Your tasks and responsibilities:**
- Design, maintain, optimize, and troubleshoot hybrid HPC systems, e.g. clusters and cloud, storage, and user interfaces, ensuring high availability and performance
- Implement and manage HPC-related software stacks (e.g. schedulers, remote access)
- Create documentation and guide researchers through project planning, development, and testing; encourage best practices in scientific computing, programming, and efficient HPC resource utilization
- Collaborate with research teams on interdisciplinary projects, provide technical insights and support in designing scalable, HPC-based solutions
- Contribute to grant writing, research proposals, and technical documentation to support HPC and funding initiatives
- Stay ahead of emerging HPC trends, tools, and architectures for our hybrid cloud stack, recommend improvements or adaptations in technology that align to academic teaching and research combined with required industry needs

**Your strengths and skills:**
- Academic degree in Computer Science, Information Technology, Engineering or a related field
- 5+ years of professional experience in the High Performance Computing field
- Systems: Strong knowledge of Linux/Unix, hybrid HPC approaches, and IT Infrastructure and applications
- Scheduling and tooling: Experience with cluster management tools and schedulers (e.g. SLURM), compilers, libraries, and user environments (e.g. JupyterHub, Open OnDemand); experience with Kubernetes and/or OpenStack is advantageous
- Programming: Proficiency in multiple languages such as Python and C++; scripting skills (e.g. Bash)
- Architecture: Knowledge of CPU and GPU architectures; experience with NVIDIA-based clusters
- Data and storage: Proficiency in data management and storage systems, including transfer protocols
- Teaching and mentorship: Ability to explain complex concepts clearly, to design and deliver lectures, labs, or workshops on HPC-related topics
- English skills on minimum level C1
- Strong communication and problem-solving skills; experience in working with internal/external project management teams and research groups is an asset
- Excellent interpersonal skills, customer service mindset, well-developed organizational and planning skills, able to advise, guide, and anticipate future trends
- Experience in higher education or public sector environment is a plus

---

## 57. HPC Cluster Architect - Nexgen Cloud
...
## 58. HPC Specialist Architect - AWS Energy & Utilities
...
## 59. Linux Systems Administrator -- HPC - Turin, Italy

**Work place:** Turin - Italy

If selected, after a probation period of approximately 2 months in our offices in Turin, the candidate will have the option to work remotely from anywhere in Italy, and will be requested to come to Turin once every 2 months for business meetings.

**Job description**

Do IT Now is looking for a passionate and very proactive Linux Systems Administrator to join HPC support team.

The ideal candidate will be responsible for Installation, configuration and maintenance of HPC systems based on GNU/Linux distributions as well as all related software components.

The ideal candidate will also be responsible for designing and configuring HPC cluster architectures, including all hardware and software components (servers, high-speed interconnects, storage, queue management tools, etc.).

Working in team with our application and system engineers, the candidate will be responsible for identifying advanced solutions, installation and configuration of HPC applications, as well as developing applications performance improvements. The candidate will also be responsible for client/user training.

**Skills and Experience**

*Essential skills*
- High school diploma or degree in Computer Science, Computer Engineering or similar.
- 5+ years of experience in similar roles.
- Fluent English and Italian.
- Good knowledge of Linux Enterprise distributions (RedHat EL, SLES, etc.)
- Knowledge Backup and Scripting with Bash and Python.

*Technical skills and experience:*
- Linux Enterprise distributions (RedHat EL, SLES, etc.)
- Networking: Switching, VLAN, FireWall
- Monitoring Systems: Zabix, Nagios
- Backup and Scripting with Bash and Python
- Parallel File System (Lustre, BeeGFS, GPFS, CEPH, etc.)
- HPC Scheduler: PBS, LSF, SLURM etc.
- Docker, Singularity, R.H. Container
- Deployment tools: Xcat, Bright Cluster Manager
- Automations Tools: Ansible, Puppet

*Desirable skills and experience*
- Openshift
- Openstack
- DDN, NetApp, Isilon, Qumulo
- VmWare, Citrix, KVM, Hyper-V
- Relational database (MySQL, Ost, Postgres)
- Knowledge and previous experience of DELL, HPE and Lenovo Server Platforms.

*Personal Attributes*
- Based in taly
- Teamwork attitude, leadership and ability to innovate, proactivity and good communication, and focus on achieving results.
- Availability to business travels.

**What we offer?**
- CCNL Metalmeccanico Industria, Ticket Restaurant 8€, Welfare, Salary range Ral 30.000 - 40.000 € .
...
- We offer a full-time contract in a highly stimulating and challenging environment.

---

## 60. HPC / GPU Cluster Engineer - European - REMOTE

We're working with a market-leading Neo-Cloud company specialising in AI infrastructure and GPU engineering. Operating globally and expanding at pace, they are redefining how high-performance compute is delivered at scale.

As part of continued growth, they are strengthening their HPC team and are looking for an experienced HPC / GPU Cluster Engineer to help design, operate, and optimise large-scale GPU environments used by AI and machine learning workloads worldwide.

This is a highly technical, hands-on engineering role focused on GPU cluster engineering, performance optimisation, and reliability. You'll work closely with platform, SRE, and AI teams to ensure GPU infrastructure performs reliably and efficiently at scale.

If you're passionate about GPU performance, scalable infrastructure, and HPC engineering, this is a rare opportunity to work at the forefront of AI infrastructure.

**Key Responsibilities**
- Design, deploy, and operate large-scale GPU clusters
- Manage and optimise GPU scheduling and resource utilisation
- Performance benchmarking and tuning for AI / HPC workloads
- Work with SLURM, Kubernetes, and hybrid orchestration environments
- Troubleshoot performance, scalability, and reliability issues
- Contribute to SRE practices: monitoring, automation, incident response
- Improve cluster observability, resilience, and operational tooling

**Skills & Requirements**
- Strong experience with GPU cluster engineering at scale
- Hands-on knowledge of SLURM and/or Kubernetes for GPU workloads
- Experience with performance benchmarking, profiling, and optimisation
- Comfortable operating production systems in high-availability environments
- Familiar with SRE principles (monitoring, alerting, automation, reliability)
- Solid Linux background and strong scripting skills (Python, Bash, etc.)
- Experience supporting AI, ML, or HPC workloads in production

**Nice to Have**
- Experience with multi-tenant GPU platforms or cloud-scale environments
- Knowledge of NVIDIA GPU ecosystems (CUDA, NCCL, drivers, firmware)
- Exposure to InfiniBand, high-speed networking, or distributed storage

---

## 61. Senior HPC Platform Engineer
...
## 62. HPC / GPU Infrastructure Engineer - FirstPrinciples
...
## 64. HPC Storage and Compute Architect - KLA
...
**Minimum Qualifications:** Requires minimum of 8 years of related experience with a Bachelor's degree; or 6 years and a Master's degree; or a PhD with 3 years experience; or equivalent experience.

**Base Pay Range: $129,600.00 - $220,300.00 Annually**

---

## 65. Scientific Computing Administrator - General Atomics
...
## 66. RISC-V AI / HPC & Agentic Software Engineering Lead - Tenstorrent (Taiwan)
...
## 67. HPC Systems Administrator - Mass General Brigham
...
*Licenses and Credentials:* Class D Passenger Vehicle Driver's License preferred
*Experience:* Experience in systems/applications administration. 2-3 years required.
...
## 68. Sr. HPC Systems Engineer - Johns Hopkins University
...
## 69. HPC Software Engineer - The San Francisco Compute Company
...
- You're open to coming to our San Francisco office 3--4 days per week
...
## 71. HPC & Linux Systems Engineer - Ben-Gurion University

Ben-Gurion University of the Negev is seeking an experienced HPC & Linux Systems Engineer to support and advance the Faculty of Computer Science and Information Systems' high-performance computing infrastructure, cloud services, and research computing environments.

This role combines HPC administration, Linux systems engineering, DevOps practices, AI infrastructure, and cutting-edge research technologies in a highly innovative academic environment.

**Key Responsibilities**
- Manage High Performance Computing (HPC) clusters and cloud-based services supporting research and teaching activities.
- Develop, maintain, and optimize Linux-based computing environments and open-source infrastructure.
- Administer and support HPC technologies including Slurm, Kubernetes, containers, and distributed computing environments.
- Evaluate, implement, and integrate advanced technologies in AI, scientific computing, and HPC.
- Design and implement DevOps processes, automation tools, and user environments.
- Monitor, analyze, and optimize system, cluster, and GPU performance.
- Develop administrative tools and automation scripts using Python and Bash.
- Install, configure, and maintain Linux servers and infrastructure.
- Provide technical support and training to faculty members, researchers, and students.

**Requirements**
- Bachelor's degree in Engineering, Computer Science, Software Engineering, Information Systems, or a related field.
- At least 3 years of relevant experience.
- Strong experience with Linux administration and Docker containers.
- Hands-on experience with HPC environments, including Slurm and Kubernetes.
- Experience with parallel computing libraries and workload scheduling systems.
- Experience analyzing system, cluster, and GPU performance.
- Proficiency in Python and Bash scripting.
- Experience with automation and infrastructure management tools such as Ansible, Foreman, Shell scripting, or similar.
- Advantage: experience with GitHub and large-scale automation environments.

---

## 72. HPC / AI Specialist - AI4I (Turin, Italy)
...
## 73. HPC Performance Engineer - NVIDIA (Compilers & Tools)
...
## 74. Senior Linux System Administrator - HPE (HPC/AI Labs)
...
**Salary Range: Annual Salary USD 98,000 - 185,200 in Colorado // 105,500 - 213,500 in California // 92,600 - 213,500 in Minnesota & Texas & Wisconsin**

---

## 75. Senior HPC and AI Cluster Administrator - Accenture Federal Services
...
## 76. HPC Engineer - CoreWeave (NVLink/NVSwitch)
...
CoreWeave is building and operating some of the largest GPU infrastructure in the world. The Metal Net team owns the high-bandwidth GPU interconnect platforms that make large-scale AI and HPC workloads possible, including NVLink and NVSwitch-based systems.
...
**The base salary range for this role is 262,000-350,000 PLN.**

---

## 77. HPC System Administrator - Santa Clara University
...
**PROVIDES WORK DIRECTION:** May supervise student workers.
...
## 78. HPC Cluster Engineer - NVIDIA (EDA)
...
## 79. RISC-V AI / HPC & Agentic Software Engineering Lead - Tenstorrent (North America)
...
## 80. Senior HPC and LSF Operations Engineer - NVIDIA
...
Experience supporting execution of distributed workloads on HPC cluster platforms. Candidates should understand how compute workloads interact with cluster schedulers, compute nodes, and distributed resources.
...
Ability to identify issues affecting workload execution including inefficient resource allocation, scheduler configuration issues, application execution failures, distributed compute performance bottlenecks.

*Automation and Operational Tooling*
Experience writing scripts or tooling using languages such as Bash, Python. Automation experience supporting workload execution or operational tasks is beneficial.
...
## 82. Distinguished Software Architect - Deep Learning and HPC Communications - NVIDIA
...
## 83. Senior Software Engineer - HPC - NVIDIA
...
Experience supporting multi-node Linux compute clusters, including node integration, configuration, and operational sustainment. Experience with cluster provisioning tools such as xCAT, Warewulf, or similar node deployment systems is beneficial.

*Workload Scheduling Platforms*
Experience supporting distributed compute workloads using schedulers such as Slurm, PBS / PBS Pro, Torque, Grid Engine. Candidates should understand queue configuration, job submission workflows, and scheduler troubleshooting. Candidates should understand how workload schedulers interact with distributed compute workloads and containerized execution environments.

*Linux Systems Administration*
Strong Linux administration experience including command-line system administration, server and compute node configuration, system troubleshooting in distributed compute environments. Experience With RHEL-based Environments Is Preferred.

*Distributed and Containerized Workloads*
Experience supporting distributed compute workloads utilizing parallel computing frameworks such as MPI, OpenMP, GPU compute frameworks. Candidates should understand how workload schedulers interact with distributed compute workloads and containerized execution environments within HPC clusters. Familiarity with container technologies commonly used in HPC environments such as Docker, Podman, Singularity / Apptainer. Candidates should understand how containerized workloads interact with schedulers, GPU resources, and distributed compute environments. Experience supporting containerized HPC workloads or integrating container platforms with cluster infrastructure is desirable.

*HPC Networking*
Familiarity with high-performance networking technologies including RDMA networking, InfiniBand, high-throughput cluster networking architectures. Candidates should be comfortable assisting with troubleshooting cluster communication or performance issues.
...
*Automation and Operational Tooling*
Experience writing scripts or operational tooling using languages such as Bash, Python. Automation experience supporting system administration or cluster operations is beneficial.
...
## 85. HPC Operations Engineer - NVIDIA (India)
...
## 86. Senior HPC Infrastructure Engineer - University of Warwick
...
## 87. HPC & AI Performance Engineer - HPE

**Job Description**

HPE is seeking a High-Performance Computing (HPC) Benchmarking Performance Engineer to work with both standard and scientific application benchmarks on HPE's supercomputing platforms. Familiarity with HPC is advantageous, particularly in areas such as processor performance, network technologies, software expertise, and application performance and scalability. The ideal candidate will demonstrate strong technical skills in HPC scientific application software, performance analysis, and a solid understanding of HPC hardware and architecture, applying this knowledge to benchmarking activities for HPE supercomputers deployed globally.

HPE operates in a fast-paced and ever-changing environment. We are looking for driven engineers who consistently deliver the high-quality results for HPE's HPC & AI customers.

**Responsibilities**
- Successfully complete long and short-term benchmark projects involving some of the largest HPC systems in the world that utilize the newest HPC technologies.
- Understand HPC architectural components and features, as well as performance estimation methodologies used to provide required information and performance assessments for benchmarks on future HPE and competitive systems.
- Complete and provide technical analysis of HPC I/O, standard and scientific application performance-based benchmark tests.
- Identify solutions, define action plans, and help coordinate and deliver optimal benchmark enhancements and solutions.
- Proactively develop and maintain advanced knowledge of HPE and competitor HPC products by participating in targeted training sessions, and collaborating with internal and external HPC experts. Apply specialised HPC performance optimisation techniques including parallel processing, efficient memory management, and comprehensive code profiling to ensure delivery of robust benchmark performance results on HPE's HPC and AI systems.

**Qualifications**
- Experience with storage benchmarks, profiling tools and/or software for HPC systems. Coursework and internship experience is considered relevant
- Knowledge of HPC system components that include processor technologies, accelerator technologies, memory technologies, & software technologies -- and the ability to understand their impacts on various HPC benchmarks.
- Understanding of parallel programming techniques and algorithms.
- Ability to take on some of the most challenging HPC projects to advance the capabilities of HPC which will benefit HPE customers and the world.
- A demonstrated ability to assess and optimize aspects of computational application benchmark performance on HPC Linux based system
...
- Ability to use Performance profiling tools and debugging tools on Linux based systems.
- Familiarity with analyzing and assessing benchmark and application performance for HPC systems.
- Excellent analytical and problem-solving skills.
- Excellent written and verbal communication skills; mastery of English required.
- Masters degree [PhD preferred] in a technical field (Computer Science, Mathematics, Engineering, Physics, Chemistry, Environmental, etc.).

**Salary Range: Annual Salary USD 62,900 - 145,300 in Minnesota**

---

## 88. HPC Consultant - Fujitsu

**Key Accountabilities**

- Design, deploy, and maintain HPC.
- Experience in high-performance computing (HPC) infrastructure deployments
- Lead the technical architecture of compute clusters, high-speed interconnects, and storage systems.
- Work closely with R&D teams to align infrastructure with application and research requirements.
- Define operational standards, automation strategies, and best practices.
- Ensure platform availability, performance, and security.
- Continuously evaluate emerging technologies and their applicability.
- Act as a technical reference for HPC and quantum computing within the organization.

**Responsibilities**

Design and implementation of:
- HPC platforms: compute clusters, GPU acceleration, high-performance interconnects (InfiniBand, advanced Ethernet).
- Scheduling and orchestration: SLURM, PBS, or similar workload managers.
- Storage systems: parallel file systems (Lustre, GPFS), object storage, and hybrid solutions.
- Containers and reproducible environments: Singularity/Apptainer, Docker, Kubernetes for HPC workloads.
- Automation & Infrastructure as Code: Ansible, Terraform, CI/CD pipelines.
- Quantum computing integration: quantum simulators, SDKs (Qiskit, Cirq, Braket), and cloud or hardware backends.
- Performance tuning and resource optimization.
- Advanced user support and incident resolution.
- Technical documentation and knowledge sharing.
- Collaboration with vendors, research centers, and technology partners.

**Strong Experience In**

*Desired Skills and Qualifications Technical Skills*
- Large-scale Linux systems.
- HPC and accelerated computing (CPU/GPU).
- SLURM or other job schedulers.
- High-performance networking (InfiniBand, RDMA).
- HPC containers (Singularity/Apptainer).
- Automation (Ansible, Terraform, Bash, Python).
- Knowledge of: Quantum computing fundamentals and hybrid workflows, Quantum SDKs (Qiskit, Cirq, Braket, or similar), HPC--Cloud integration (AWS, Azure, GCP).
- Experience with NVIDIA/AMD hardware and Mellanox networking is a plus.
- Ability to translate scientific or business requirements into technical solutions.
- Languages: Spanish & English

**Experience**

Proven experience (3+ years) as:
- HPC Platform Engineer
- Scientific Computing Systems Engineer
- DevOps / SRE in high-performance environments
- Experience in research institutions, supercomputing centers, or advanced industrial environments is highly valued.

**Why Join Us**
- Cutting-edge technology: work with HPC and quantum computing applied to real-world challenges.
- High impact: your platforms will enable critical scientific and industrial projects.
- Collaborative culture: highly skilled, multidisciplinary teams.
- Professional growth: access to advanced training, certifications, and collaboration with leading technology partners.

---

## 89. Senior HPC Infrastructure Engineer - Firmus Technologies
...
## 90. AI/HPC System Architect - SK hynix America

**Job Title:** AI/HPC System Architect
...
- Continuously monitor industry trends and emerging technologies related to AI and HPC infrastructure from sources such as cloud service providers, OEMs, and national labs.
- Promote and establish collaborative partnerships with customers for on-site proof-of-concept initiatives involving advanced memory solutions, aligning with the proposed infrastructure architecture.
- Provide strategic direction and recommendations for the adoption and integration of advanced memory solutions within the infrastructure.

**Qualification**
- Ph.D in Electrical and Computer Engineering, or related field with 15+ years of experience in system architecture for large-scale computing, with specific AI focus preferred.
...
- Effective collaboration and partnership-building skills for engaging with customers and stakeholders.
- Experience in planning and executing on-site proof-of-concept initiatives to validate infrastructure solutions.
- Excellent communication skills to convey architectural concepts and influence stakeholders.
...
**Salary Range in San José, CA: $155,000 - $255,000 per year**

---

## 91. Senior Engineer - HPC Operations - Core42 (Abu Dhabi)
...
## 92. Senior AI and ML HPC Cluster Engineer - NVIDIA (California)
...
- Experience with multiple storage solutions such as Lustre, GPFS, familiarity with newer and emerging storage technologies.
- Background with RDMA (InfiniBand or RoCE) fabrics

---

## 95. HPC Systems Engineer - KLA (Ann Arbor, MI)
...
With over 40 years of semiconductor process control experience, chipmakers around the globe rely on KLA.
...
## 96. HPC Systems Engineer - KLA (Singapore)
...
## 97. HPC Linux Systems Administrator 3/4 - Northrop Grumman
...
The Northrop Grumman Classified Solutions team is seeking an HPC/Linux Systems Administrator to support information system lifecycle activities. The selected candidate will be required to work on-site, full-time at our Palmdale, CA location.
...
- Perform as Linux Systems Administrator for a medium to large sized classified program.
...
- Support multiple networks; ensure necessary administration tasks are completed.
- Work closely with System Engineering and other team members to develop recommended system improvements, upgrades, and solutions.
- Recommend and implement system enhancements to improve performance and reliability of systems, including installing, upgrading/patching, monitoring, problem resolution, and configuration management.
- Administer backup and recovery services; manage file systems and disk space; manage virus protection on a routine basis.
...
- Interact, meet, discuss, and troubleshoot issues with team members, suppliers, customers, and vendors.
...
- Report on project status as required for all recurring and non-recurring efforts.
...
- Associate's degree and 7 years of relevant experience OR Bachelor's degree and 5 years of relevant experience OR Master's degree and 3 years of relevant experience; a High School diploma or equivalent and 9 years of related experience may be considered in lieu of a completed degree.
- Candidates must have a current US Government Secret security clearance (at a minimum) to be considered
...
- Current Security + CE (or greater) certification OR the ability to obtain certification within 6 months of hire date.
...
- Associate's degree and 10 years of relevant experience OR Bachelor's degree and 8 years of relevant experience OR Master's degree and 6 years of relevant experience; a High School diploma or equivalent and 12 years of related experience may be considered in lieu of a completed degree.
- Candidates must have a current US Government Secret security clearance (at a minimum) to be considered
- Candidates must have the ability to obtain access to Special Programs as a condition of employment, maintaining Special Programs access will be a condition of employment
- Current Security + CE (or greater) certification OR the ability to obtain certification within 6 months of hire date.
- Must have Linux Operating Systems support experience
...
- Experience with architecture and design (architecture, design patterns, reliability, and scaling) of new and existing HPC systems. Strong knowledge of HPC technologies, storage, parallel processing, and scientific computing frameworks. Experience building and maintaining high scale distributed systems and running scalable distributed application software. Hands-on experience with HPC hardware diagnostic and repair.

**Salary Range: Level 3: $103,600.00 - $155,400.00**
**Salary Range: Level 4: $129,300.00 - $193,900.00**

---

## 98. Senior HPC Cluster Engineer - Nebius
...
## 99. Senior HPC Cluster Engineer - NVIDIA (Redmond)
...
## 100. Senior HPC and AI Operation Engineer - NVIDIA (Israel)
...
## 103. Data Center Engineer, HPC and AI - NVIDIA (Israel)
...
## 104. Senior HPC Solutions Architect - NVIDIA
...
## 105. Senior HPC Engineer - NVIDIA (Shenzhen)
...
## 106. Senior HPC Performance Engineer - NVIDIA (Israel)
...
## 107. Systems/Software Engineer-- HPC Diagnostics & Test - HPE (Costa Rica)

We're looking for a Engineer to join our GTCS HPC & Compute team, focused on building and enabling diagnostics and factory test solutions for next-generation server platforms.

In a typical day as a Systems/Software Engineer-- HPC Diagnostics & Test, you would...
- Develop and enhance Python-based test and diagnostics tools
- Debug issues across software, OS, and system-level interactions
- Support new product introductions (NPI) and factory test enablement
- Work with cross-functional teams (R&D, Product, Manufacturing) to solve complex integration challenges
- Contribute to test automation, CI/CD, and agile development practices.
...
**Nice To Have**
- Experience with hardware-software integration, diagnostics, or test automation.
- Exposure to firmware, UEFI, or system-level debugging.

**Additional Skills:** Cloud Architectures, Cross Domain Knowledge, Design Thinking, Development Fundamentals, DevOps, Distributed Computing, Microservices Fluency, Full Stack Development, Security-First Mindset, Solutions Design, Testing & Automation, User Experience (UX)

---

## 108. Senior AI and HPC Observability Engineer - NVIDIA
...
## 109. HPC User Support Engineer - Argonne National Laboratory

The Argonne Leadership Computing Facility (ALCF) is home to one of the world's pioneering exascale supercomputers, Aurora. Argonne and ALCF are proud to play a pivotal role in the Genesis Mission, a national effort to harness AI for breakthroughs in various fields of science, energy, and national security.
...
## 110. Senior Site Reliability Engineer, HPC and LSF - NVIDIA (Bangalore)
...
- Excellent problem-solving skills, with the ability to analyze complex systems, identify bottlenecks, and implement scalable solutions.
- Excellent communication and teamwork skills, with the ability to work effectively with diverse teams and individuals.
- 5+ years experience in a large, distributed Linux environment.
...
What if your expertise in high-performance C++ could directly shape the infrastructure powering next-generation AI? We're looking for a Senior C++ Engineer to build and optimize the systems that leading AI labs depend on --- from data pipelines and annotation tooling to evaluation infrastructure that influences how frontier models are trained and benchmarked.

This is a fully remote, flexible contract role for a seasoned systems engineer who wants meaningful, high-impact work at the cutting edge of AI development.
...
- Improve reliability, throughput, and safety across existing production C++ codebases
- Identify performance bottlenecks, edge cases, and systemic issues --- then implement scalable, elegant fixes
- Collaborate with data, research, and engineering teams to accelerate model training and evaluation cycles
...
- 5+ years of professional experience writing production-grade C++ (C++17 or C++20 preferred)
- Deep understanding of computer architecture, SIMD intrinsics, and cache coherency for compute-heavy workloads
- Expertise in lock-free programming and maximizing parallelism using threading libraries
...
**Salary Range in Seattle, WA: $50 - $75 per hour**
...
## 121. Solutions Architect, AI for Science and HPC - NVIDIA (Japan)
...
## 124. Senior HPC Architect, Automation and At-Scale Deployment - NVIDIA (New Mexico)

**Location:** New Mexico, United States (Remote)
...
## 126. Senior HPC and AI Network Software Architect - NVIDIA (Germany)
...
## 127. Technical Business Analyst (HPC, Linux) - DSM-H Consulting

**Location:** Peoria, IL (Presencial)

**Role and Overview of the Role**
- Current team supports enterprise initiatives.
- Engineering-centric and IT-based team.
- Team is a globally distributed group.
- Business Analyst role with partial IT Architect responsibilities.
- Responsible for understanding demand signals.
- Responsible for understanding usage patterns.
- Relationship management with the extended enterprise.
- Role is approximately 50% technical and 50% business/project coordination.
- Not a day-to-day administration role.

**Top Skills**
- Domain-specific experience in High-Performance Computing (HPC).
- Knowledge of parallel systems, cluster systems, CPU and GPU hardware, and optimization.
- General infrastructure knowledge, including Linux and Windows.
- HPC-specific technologies are preferred.
- Understanding of demand signals, usage patterns, and enterprise relationships.

**Nice to Have:**
- HPC Hybrid Deployment experience.
- GPU-specific technologies.
- Slurm.
- InfiniBand.

**Position's Contributions to Work Group:**
- Provides end to end technical and strategic leadership for enterprise HPC platforms that enable advanced engineering, simulation, analytics, and AI/ML workloads.
- This role combines deep system architecture expertise with business analysis and technology strategy, ensuring HPC investments are aligned with business priorities, deliver measurable value, and scale with future demand.

**Typical task breakdown:**
- Lead the architecture, design, and lifecycle management of on prem, hybrid, and cloud based HPC platforms.
- Define reference architectures for compute (CPU/GPU/accelerators), high speed interconnects, parallel storage, and workload orchestration.
- Translate complex workload requirements into scalable, resilient, and cost effective system designs.
- Establish performance benchmarks, capacity models, and scaling strategies.
- Evaluate emerging technologies and guide vendor selection and platform roadmaps.
- Ensure compliance with security, reliability, availability, and enterprise architecture standards.

**Interaction with team:**
- Liaison to HPC operations team, business unit stakeholders, and Client IT infrastructure teams. Participation in weekly team standups and facilitation of

**Team Structure:**
- Globally distributed operations

**Work environment:**
- Full time in office (Mossville, Tech Center)

**Education & Experience Required:**
- Years of experience: Bachelor's degree in a technical field such as computer science, computer engineering or related field required.
- Degree requirement: 5-7 years experience

**Top Skills (Required)**
- Linux systems and automation
- HPC schedulers (e.g., Slurm, PBS, LSF)
- High speed networking (InfiniBand, high performance Ethernet)
- Parallel and distributed storage systems
- Strong analytical skills with experience in capacity planning, cost modeling, and trade off analysis.

**Additional Technical Skills (Required)**
- Experience supporting executive level decision making for technology investments.
- Exposure to cloud and hybrid HPC strategies.
- GPU accelerated computing and AI/ML workloads.
- Infrastructure as Code and automation (e.g., Ansible, Terraform).
- Experience participating in architecture governance or enterprise standards bodies.
...
## 128. High Performance Computing (HPC) System Administrator - Raytheon

**Location:** Tucson, AZ (Presencial)

**Date Posted:** 2026-05-13
**Country:** United States of America
**Location:** US-AZ-TUCSON-M05 ~ 1151 E Hermans Rd ~ BLDG M05 (External Site)
...
**System Administrator, High Performance Computing (HPC) -- P1**
**Analyst Level**

**What You Will Do:**
- Work as a team member in a fast-paced technological environment.
- Help develop and implement new technologies based upon industry best practices.
- Use troubleshooting techniques to resolve technical problems at a high scope and complexity to include the integration of High-Performance Computing hardware, software, and operating systems (OS).
- Understanding software tools, automated scripts, batch schedulers, hardware, and system-level troubleshooting, to lead and support the engineering community.
- Perform OS tuning to maximize system performance on high performance computing systems. Work across DT functions to standardize processes and procedures.
- Work with Cybersecurity professionals to maintain security compliance requirements.
- Provide documentation and training on advanced DT HPC processes and procedures. Be a mentor to junior team members.
- Must be able to obtain required Department of Defense Directive (DoDD) 8140 / 8570 Certification requirements (CompTIA Security+ CE or equivalent certification and an Operating System Certification) within 6 months of hire date.

**Qualifications You Must Have:**
- Typically requires a bachelor's degree and less than 2 years of relevant experience or a total of 4 years relevant technical experience in IT or Digital Technology.
...
- Experience in Windows and/or Linux Server Environments including directory services management, and system hardening.

**Qualifications We Prefer:**
- High Performance Computing (HPC) experience in a Linux environment.
- Experience in project leadership, management, or project management in a DT domain and basic to advance scripting experience.
- Experience maintaining a medium sized Microsoft Windows Server environment.
- Experience with Red Hat Enterprise Linux.
- Experience with High Performance Computing scheduling and monitoring tools.
- An active DoD Secret or Top-Secret Clearance.
- Advanced hands-on experience with Windows and Unix security hardening, systems integrations, advanced troubleshooting, and authentication service integration (LDAP).
- Unix (Including Linux and Solaris), experience in a medium to high complex environment(s).
- Working knowledge of High-Performance Computing scheduling and monitoring tools such as SLURM, Grid Engine and Ganglia.

**Salary Range: $57,200 - $108,800 USD**

---

## 129. Senior HPC Cluster Engineer - Jobgether (Switzerland)
...
## 130. Senior HPC DevOps Engineer - NVIDIA AI (UK)

**Location:** Layer-De-La-Haye, England, United Kingdom (Presencial)
...
## 131. HPC AI Engineer, Frontier - A*STAR (Singapore)

**Location:** Singapore (Presencial)
...
## 132. Principal/Staff HPC Network Engineer - San Francisco Compute Company

**Location:** San Francisco, CA (Presencial)
...
## 133. Senior Math Libraries Engineer -- AI and HPC - NVIDIA (Santa Clara)
...
## 134. Senior HPC and AI Networking Performance Research and Analysis Engineer - NVIDIA (Shanghai)

**Location:** Shanghai, China (Presencial)
...
**Salary Range:** $156,864 - $191,724 (Level 3) / $178,644 - $218,364 (Level 4)
...
**Responsibilities in Additional Responsibilities if hired at a Level 4:**
...
## 137. Senior HPC Engineer - NVIDIA (Shanghai)
...
## 142. Junior HPC Network Engineer - Mistral (Paris Region)

**Location:** Paris, Ilha de França, França (Híbrido)
...
As a Junior HPC Network Engineer, you will support the design, deployment, and optimization of high-performance network infrastructures for Mistral's HPC clusters and AI workloads. You will work closely with senior engineers to learn, troubleshoot, and contribute to the networking solutions that power our AI research and production environments. This role is ideal for someone eager to grow their expertise in HPC networking while collaborating with a cross-functional team.

**Key Responsibilities**
- Assist in the design and deployment of high-performance, low-latency network architectures for HPC environments, including InfiniBand, RoCE, and high-speed Ethernet, under the guidance of senior engineers
- Support the integration of networking solutions with compute clusters, storage systems, and cloud platforms, collaborating with HPC, DevOps, and AI research teams.
- Troubleshoot network issues with supervision, following escalation procedures to minimize downtime and maximize performance.
- Monitor network performance, capacity, and security, and assist in implementing improvements as directed.
- Document network configurations, architectures, and operational procedures to ensure knowledge is shared and retained.
- Stay updated with emerging HPC networking technologies and best practices, and participate in their adoption within Mistral.
- Learn from senior team members to develop expertise in HPC networking protocols, hardware, and automation tools.

**Qualifications & Experience**

*Technical Skills (Required)*
- Basic understanding of networking protocols (e.g., TCP/IP, InfiniBand, or RoCE).
- Familiarity with network hardware (e.g., switches, routers, NICs) from vendors like Mellanox, Cisco, or Arista (hands-on experience is a plus).
- Exposure to network automation tools (e.g., Ansible, Python scripting) or a strong willingness to learn.
- Basic knowledge of HPC environments, parallel computing, or distributed systems (academic or project-based experience is acceptable).
- Awareness of network security best practices.

*Technical Skills (Nice to Have)*
- Experience with Linux/Unix systems and command-line tools.
- Exposure to cloud networking (AWS, GCP, Azure) or hybrid environments.
- Familiarity with monitoring tools (e.g., Prometheus, Grafana, Wireshark).

*Soft Skills:*
- Strong problem-solving and analytical skills with a willingness to learn
- Ability to thrive in a fast-paced, collaborative environment with guidance from senior team members.
- Excellent communication skills (English required; French is a plus).
- Eagerness to document and share knowledge with the team.

*Education*
- Bachelor's or Master's degree in Computer Science, Engineering, or a related field OR equivalent practical experience (e.g., internships, personal projects, or certifications).
- Recent graduates or early-career professionals are encouraged to apply

---

## 143. Site Reliability Engineer, HPC / AI Infrastructure - Tesla (Bangalore)
...
## 144. HPC Systems Engineer - Global Infotech Network Pvt. Ltd. (India)

**Location:** Deli, Índia (Remoto)

**HPC System Engineer**

**Overview:**

We are seeking a skilled and motivated HPC Systems Engineer with a strong background in supporting Microsoft HPC Pack environments. This role is ideal for candidates with at least 3 years of hands-on experience managing and optimising HPC workloads in enterprise settings. Additional experience with Azure HPC, Kubernetes, and DevOps practices is desirable and will be considered a strong plus.

**Key Responsibilities:**
- Administer, support, and troubleshoot Microsoft HPC Pack clusters in production environments.
- Collaborate with engineering and research teams to optimize HPC workloads and job scheduling.
- Monitor system performance, conduct capacity planning, and implement improvements.
- Maintain and update HPC infrastructure documentation and operational procedures.
- Work closely with cloud engineering teams to explore and potentially integrate Kubernetes or Azure HPC solutions.

**Required Qualifications:**
- Minimum 3 years of experience supporting Microsoft HPC Pack in enterprise or research environments.
- Experience with job schedulers, compute nodes, and HPC workload management.
- Strong understanding of Windows Server, and networking fundamentals.
- Familiarity with scripting languages (PowerShell, Python, etc.) for automation.

**Desired Qualifications:**
- Experience with Azure HPC services and cloud-based HPC architecture.
- Exposure to Kubernetes and container orchestration in HPC or DevOps contexts.
- Understanding of CI/CD pipelines and infrastructure-as-code tools (e.g., Terraform, Ansible).
- Experience in performance tuning and benchmarking HPC applications.

---

## 145. HPC Engineer - Jobgether (United States)
...
## 146. Advanced Technology: R&D Engineer - AI/ML, HPC - Cerebras
...
## 147. Product Development Engineer - HPC - Vicor

**Location:** Andover, MA (Presencial)

**Salary Range:** $105,000 - $130,000

**Job Summary**

Vicor is a place where engineers see the impact of their work every day. We're an American manufacturer of advanced 48V centric DC-DC converters with industry-leading power and current density, enabling breakthrough power delivery performance. As an engineering-focused company, we provide a hands-on opportunity to further innovate and advance the topologies, control systems, components and packaging of our power modules and the power delivery networks that drive key advancements in AI, electric vehicles, and aerospace.

The role of a Product Development Engineer - HPC provides direct exposure to new products and technologies, with opportunities to innovate and mature ground breaking solutions that represent the state of the art in power conversion. We are seeking individuals with creativity, talent, experience and a drive for success in a collaborative work environment. This is an ideal opportunity for someone who has strong analytical and problem solving skills, good educational background in electrical engineering, and experience designing power supplies or designing with power components. There are many opportunities to advance and increase responsibilities in Product Development Engineering in support of advanced product development.

**Job Description**

The Product Development Engineer-HPC is directly responsible for the creation of reference designs for customer specific Voltage Regulator (VR) systems, as well as the creation of simulation models, application notes, test boards, datasheets, and expert tools. The Sr. Systems Design Engineer is also a key contributor to the qualification of new products and systems. Finally there are opportunities to collaborate directly with key customers and industry leaders in defining and architecting industry leading power conversion solutions.
...
- Write complete specifications based on customer requirements and work closely with the Design Engineering organization to insure that the specification is translated into a product that will meet the original customer requirement
...
- Contact or experience with Blue Chip or Tier 1 VR customers desired.
...
- Familiarity with Intel VR specifications for CPU core or Memory a plus.
- Familiarity with modeling and design tools such as MATLAB Simulink, Altium, SPICE, Simplis, and Simetrix.

---

## 148. Systems Engineer (CBDS/HPC) - National University of Singapore

**Location:** Cingapura, Cingapura (Presencial)

**Job Title:** Systems Engineer (CBDS/HPC)
...
## 149. Co-design engineer for future computing architectures in HPC - CEA

**Location:** Saclay, Ilha de França, França (Presencial)
...
## 150. HPC Hardware/Network Engineer-- Linux Systems - Quest Global

**Location:** Milpitas, CA (Presencial)

Quest Global delivers world-class end-to-end engineering solutions by leveraging our deep industry knowledge and digital expertise. By bringing together technologies and industries, alongside the contributions of diverse individuals and their areas of expertise, we are able to solve problems better, faster. This multi-dimensional approach enables us to solve the most critical and large-scale challenges across the aerospace & defense, automotive, energy, hi-tech, healthcare, medical devices, rail and semiconductor industries.

We're looking for a hands-on HPC Engineer to assist with the setup, maintenance, and operation of our high-performance computing cluster. This role is ideal for someone with practical experience in Linux systems, containers, and basic scripting, who enjoys working in a fast-paced technical environment.
...
## 151. HPC Infrastructure Reliability Engineer - Tata Consultancy Services

**Location:** Madrid e Região (Híbrido)

Are you a HPC Infrastructure Reliability Engineer seeking a new interesting challenge?
...
- Solid knowledge of high-speed networking (e.g., InfiniBand, high-throughput Ethernet)
- Proven experience in Infrastructure as Code (IaC) and automation (Python, Bash, Ansible, or similar)
...
## 153. HPC - Senior Software Engineer - Linux, Shell, Python - Erias Ventures
...
## 154. Platform Engineer (ML Infrastructure) - TANUH
...
- Cloud Integration Experience( Optional): Hands-on experience with cloud platforms (GCP preferred). Must be proficient in deploying and using cloud command-line tools, managing cloud storage buckets, configuring IAM permissions for headless machine accounts, and scripting secure hybrid data transfers.
...
## 155. Senior High Performance Compute (HPC) Verification & Validation Engineer - Schaeffler

**Location:** Bangalore, Carnataca, Índia (Presencial)

Schaeffler is a dynamic global technology company and its success has been a result of its entrepreneurial spirit and long history of private ownership. Does that sound interesting to you? As a partner to all of the major automobile manufacturers, as well as key players in the aerospace and industrial sectors, we offer you many development opportunities.

The performance of the applied software testing strategy is analyzed and continuously improved to ensure competitiveness of SAG's embedded software development. The Target of this role is to ensure a highly effective and efficient testing approach that maximizes reuse, automation and virtualization in both development and testing processes. A well-aligned software testing strategy that leverages advanced test methods (e.g. Continuous Integration/Continuous Testing), environments (including cloud-based) and tools is provided for achieving cost-effective software development. This role serves as a key enabler for maintaining a competitive edge in the rapidly evolving automotive software landscape.

**Your Key Responsibilities:**
- Requirements Analysis & Test Strategy definition
- Test Planning & Test Architecture definition
- Automation & CI/CT Integration
- Usage of Simulation & Virtual Validation tools where applicable
- Definition and Execution of Model, HiL and Vehicle Level testing
- Consider Functional Safety & Cybersecurity in V&V activities
- Training of Developers, Test Engineers
- Drive continuous improvements in V&V methodologies

**Your Qualifications:**
- University degree in a relevant field (computer science, electronics and communication, information science), master's degree desired.
- More than 4 years' experience in Automotive Software technology and experience in international Software projects with global OEM's, ideally including projects touching ADAS and/or IVI environments and their interfaces to vehicle control functions.
- Working experience with virtualization and simulation frameworks used in automotive HPC algorithm validation is an added value
- Deep knowledge of software test management and engineering related tooling
- Deep knowledge of applied software development, integration and testing workflow (e.g. model-based vs. handwritten code)
- Holistic overview on software tests, test environments and test automation related tooling
- General knowledge about software metrics and related KPIs to ensure an efficient and effective test strategy
- General knowledge about CI/CT, AI- and cloud solutions for software testing
- General overview of the testing approaches of other disciplines along the V-Cycle
- Awareness of safety-critical systems and safety standards (e.g., ISO 26262).
- Stress, performance, and workload‑based validation of compute platforms---aligned with general HPC V&V practices.
- Ability to simulate HPC compute loads and vehicle environments in model‑based validation frameworks.
- Creating rigorous test plans and executing validation activities for complex electronic systems.
- Manual and automated validation methods, regression testing, and system performance analysis.
- Ensuring traceability to requirements and adherence to automotive compliance.
- Proficiency in scripting languages such as Python to automate tests and analyze HPC behavior.

---

## 156. Systems Engineer -- HPC & GPU Infrastructure - Leidos (Junior)

**Location:** Bethesda, MD (Presencial)

**Description**

Leidos is looking for a junior-career Systems Engineer-- HPC & GPU Infrastructure with a deep understanding of operating systems, hardware, Kubernetes, and NVIDIA GPU products. As a Systems Engineer (Mid-Career) -- HPC & GPU Infrastructure, you will play a pivotal role in designing, developing, and optimizing GPU clusters for the IC community customers.
...
## 157. Application Engineer (HPC) - Cambridge Semantics Inc. / Altair
...
*What You Will Do:*
- Provision, Configure, Deploy and Support HPC products as well as our supporting products at Major & Strategic Customers.
- Help customers solve technical issues while using our job scheduling products (Grid Engine, Accelerator(NC) & PBS Pro).
- Customer facing - Should be able to understand the problem statement and deliver fixes or provide suggestions.
- Troubleshoot and resolve issues related to job scheduling and cluster performance.
- Develop and maintain scripts and tools using TCL, Bash or Python.
- Become primary technical liaison to designated strategic customers.
- Assist with testing and validation of products as part of the extended development team.
- Communicate and document bug fixes and updates internally.

**What You Will Need**

The ideal candidate should possess a strong combination of the following experiences, attributes & qualifications
- A must - Strong proficiency in Linux systems, and scripting (Unix/Linux shells, TCL, Bash, Python).
- Hands-on with HPC system administration and issue tracking and problem-solving ability.
- Expertise in networking, filesystems, and parallel filesystems.
- Experience with HPC workload managers (NC, Grid Engine, PBS Pro LSF, SLURM, etc.) and containers (Docker or Podman).
- Familiarity with debugging tools (gdb, valgrind, gstack).
- Knowledge of networking protocols (TCP, UDP) and security tools/practices (SSH, OpenSSL, SELinux, AppArmor, firewalls).
- Strong analytical and debugging skills (e.g., analyzing system and application logs, strace, lsof, gdb, gstack).
- Experience with SQL, PostgreSQL, and enterprise level data intensive applications.
- Availability for occasional travel.

**Background And Experience**
- Bachelors, Masters degree in Computer Science or related field.
- 3+ years experience in HPC system administration.
- Experience with HPC/EDA job schedulers (NC, Grid Engine, PBS Pro LSF, SLURM, etc.) and EDA CAD environment is a huge plus.
- Excellent Verbal & Written Communication Skills (English, Mandarin) are a must have.

---

## 158. HPC - Senior Software Engineer - Linux, Bash, Apache - Erias Ventures

**Location:** Annapolis Junction, MD (Presencial)

**Salary Range:** $229,000 - $251,000
...
**Clearance:** A current Top-Secret/SCI with polygraph security clearance (within 7 years) is required. Candidates cannot be sponsored or nominated for a government security clearance under this position.
...
## 159. HPC - Senior Software Engineer - Linux, Python, Bash - Erias Ventures

**Location:** Annapolis Junction, MD (Presencial)

**Salary Range:** $213,000 - $233,000

Erias Ventures was founded to serve its customers with an entrepreneurial mindset. We value creative problem-solving, open communication, and empowering our employees to make decisions and put forth new ideas.

**Description**

The Software Engineer shall be responsible for developing and maintaining system management infrastructure software and services for High Performance Computing (HPC) systems in a Linux environment.
...
## 160. HPC Operations Engineer - Lambda

**Location:** Seattle, WA (Híbrido)

**Salary Range:** $240,000 - $356,000
...
## 161. HPC Data Storage Engineer - AMERICAN SYSTEMS

**Location:** Arlington, VA (Presencial)
...
## 162. HPC Engineer, Mid - Booz Allen Hamilton
...
- Experience with parallel computing concepts such as MPI and OpenMP, in a professional or academic environment
- Experience with parallel file systems such as Lustre and GPFS or high-throughput storage
- Experience with GPU computing, including CUDA and ROCm, or GPU-accelerated workflows
- Experience in scientific software environments, including modules, Spack, and EasyBuild
- Experience with DoD HPC environments such as DREN and DSRC or other government computing resources
- Experience with CI/CD concepts and tools such as GitLab
- Secret clearance
- Security+ CE Certification

**Compensation Range: $61,900.00 to $141,000.00**

---

## 163. DevOps Engineer - HPC & Multi-Level Secure Systems - ClearanceJobs

**Location:** Herndon, VA (Presencial)

**Salary Range:** $175,000 - $210,000

ClearanceJobs is actively seeking a Senior DevOps Engineer for our client located in Herndon, VA.

**Responsibilities will include, but not limited to:**
- Own DevOps operations across Linux/Unix-based mission research environments, including system administration, patching, hardening, and configuration management from end to end.
- Design, build, and maintain CI/CD pipelines using GitLab CI, Git, SVN, and CVS; write and maintain automation scripts in Python, Perl, Bash, and Korn shell.
- Lead or independently execute initial deployments and site stand-ups for a multi-level secure enterprise system, coordinating across engineering, site staff, and program teams.
- Partner with scientists, developers, and mission users to optimize workflows, port applications, and resolve performance bottlenecks to accelerate time-to-science.
- Develop and sustain DevOps processes for provisioning, configuration management, and long-term system sustainment in classified environments.
- Produce and maintain technical documentation including deployment procedures, system runbooks, and user support materials.

**Minimum Qualifications:**
- 8--10+ years of hands-on experience in Linux/Unix administration, scripting, and configuration management in enterprise or mission-critical environments.
- Demonstrated ownership of production Linux systems --- not rotational exposure; candidates should have served as the primary administrator or lead engineer on operational environments.
- Expert-level proficiency in Python, Perl, Bash, Korn shell, and Ansible.
- Proven experience designing and maintaining CI/CD pipelines (GitLab CI, Git, SVN, CVS) in secure or classified environments.
- Hands-on DevOps automation experience with a track record of building and sustaining infrastructure independently.
- CompTIA Security+ certification required.
- Strong troubleshooting skills and demonstrated experience supporting highly technical end users.

**Preferred Qualifications:**
- Experience supporting HPC environments, scientific computing, or performance optimization (MPI, OpenMP, GPU acceleration, job schedulers such as Slurm, PBS Pro, or LSF).
- Background with multi-level security systems or similar classified enterprise deployments.
- Linux hardening and security compliance experience (STIGs, RMF, SCAP).
- Containerization or orchestration experience (Docker, Kubernetes, OpenShift).
- Infrastructure-as-Code or advanced automation tooling (Terraform, Packer, Puppet, Chef).
- Prior experience in IC or DoD R&D or operational mission environments.

**Clearance Requirements:**
- Active TS/SCI with CI Polygraph required at time of application; no sponsorship available.

---

## 164. HPC Applications Engineer - Helsing

**Location:** Munique, Baviera, Alemanha (Presencial)
...
## 165. Systems Engineer -- HPC & GPU Infrastructure - Leidos (Mid-Career)
...
## 166. HPC Systems Engineer - TS/SCI Required - Phoenix Operations Group

**Location:** Charlottesville, VA (Presencial)
...
**Skills Required:**
- Bachelors or Higher in Computer Science, Electrical Engineering, or related field. A strong background in deployment of complex deep learning architectures.
...
## 172. HPC SRE Engineer IV - Omega Enterprise Solutions

**Location:** Annapolis Junction, MD (Presencial)

**Salary Range:** $155,000 - $245,000

Omega Enterprise Solutions is a Maryland-based, Service-Disabled Veteran-Owned Small Business (SDVOSB) with a special focus on the U.S. Department of Defense (DoD) and Intelligence Community (IC) mission and enabling technologies.
...
- Additionally, candidates will have experience or exposure to XFS/ZFS File Systems and NFS/Block Storage FS Sharing; SSH, TMUX, PDSH, CLUSH system access; VI, EMACS, AWK/SES, CRON system editing; Nagios; SNMP information technology monitoring systems.
...
## 173. Systems Engineer L3 - HPC/HMD - Technology Resource Experts, LLC

**Location:** Annapolis Junction, MD (Presencial)

**Salary Range:** $175,000 - $250,000

Technology Resource Experts, LLC is looking for an experienced High-Performance Computing (HPC) Systems Engineer to support complex system design, integration, monitoring, and diagnostics by applying deep understanding of both physical and logical system architectures.
...
- Must be hardware focused and have experience with monitoring and dashboards

---

## 174. HPC Test Engineer with Security Clearance - Cornerstone Defense

**Location:** Anápolis, MD (Presencial)

**Compensation Range:** $170,000 - $190,000
...
**Position Description:** The Test Engineer shall be responsible for testing and validating HPC systems in accordance with test plans to ensure that system requirements are met.

**Required Skills:**
- Experience using Linux CLI and Linux tools
- Proficient using Bash/Python scripting for task automation
- Experience developing and executing test plans for HPC systems
- Experience integrating and testing REST APIs related to HPC systems
- Experience creating complex database queries to analyze test data across various database platforms
...
**Desired Skills:**
- Experience with the Atlassian Tool Suite (JIRA, Confluence)
- Familiar with Splunk for searching, monitoring, and analyzing machine generated data
...
## 176. VIE - HPC Technical Direction Engineer F/H - EDF

**Location:** Runcorn, Inglaterra, Reino Unido (Presencial)

**Salary Range:** €2,550 - €2,650 per year

The engineer will be part of the on-site Hinkley Point C technical direction. He/she will support to both Field engineering team and Configuration team.

As being part of the field engineer team, he/she will be responsible to provide technical support to site engineers regarding design requirements to installation and commissioning team on EM2 (primary equipment) and EM6 (insulation) scope of work.

As being part of the configuration team, he/she will support the preparation and installation teams in the identification and compliance of the site applicable documents (LDA i.e list of applicable documents), provide additional support on configuration management topics in case of task forces or urgent requests from technical direction, preparation & installation teams.

**The Technical Direction Engineer, main missions are the following:**
...
- Configuration management support: Ensure the new applicable documents requested through Client contractual instruction are integrated in the configuration tracker for site LDA,
- Follow up the preparation of the review sheet to support the applicability of a new applicable document,
...
- The Technical Direction Engineer reports to the Site Engineering Manager and Configuration Manager.
- He/she is based on HPC site.
- He/she interfaces with: Installation team and tasks leaders, Quality team, Head office in France, Germany... and principal suppliers.

**Educational basics:**
- Engineer or equivalent: technical degree

**Professional basics:**
- 3 years degree internship in mechanic is preferred
...
## 177. HPC Engineer - Yotta Data Services Private Limited

**Location:** Mumbai e Região (Presencial)

We are looking for a Senior AI/HPC Engineer to join its infrastructure Specialist team. Join the team building many of the largest and fastest AI/HPC systems in the world! we are looking for someone with the ability to work on a dynamic, customer-focused team that requires excellent interpersonal skills. This role will be interacting with customers, partners, and internal teams to analyse, define, and implement large-scale AI/HPC projects. The scope of these efforts includes a combination of Networking, System Design, and Automation, and being the face to the customer.

**What you will be doing:**
- Primary responsibilities will include deploying, managing and maintaining AI/HPC infrastructure in Linux-based environments for new and existing customers.
- Managing day to day operations for server infrastructure which includes troubleshooting
- Be the domain expert with customers during planning calls through implementation.
- Handover-related documentation and perform knowledge transfers required to support customers as they begin rolling out some of the most sophisticated systems in the world!
- Provide feedback into internal teams such as opening bugs, documenting workarounds, and suggesting improvements.
...
**What we need to see:**
- Bachelor's degree in Computer Science, Electrical Engineering or a related field, or equivalent experience.
- 4-8 years providing in-depth support and deployment services, solving problems for hardware and software products.
- Knowledge and experience with Linux System Administration, process management, package management, task scheduling, kernel management, boot procedures/troubleshooting, performance reporting/optimization/logging, network routing/advanced networking (tuning and monitoring).
- Cluster management technologies.
- Scripting proficiency.
- Good interpersonal skills with the ability to maintain and deliver resolutions for customer-blocking issues as they arise. Excellent verbal and written English skills.
- Strong organizational skills and ability to prioritize/multi-task easily with limited supervision.
- Strong knowledge on HPL/NCCL/BIOS settings and Performance troubleshooting
- Industry-standard Linux certifications.
- Experience with Schedulers such as SLURM, LSF, PBS pro, etc.
- Experience in node provisioning software such as Base Command Manager, XCAT, HPCM
...
## 178. HPC Software Engineer with an active TS/SCI with a Full Scope Polygraph Security Clearance Required - Jobs via Dice

**Location:** Maryland, Estados Unidos (Presencial)

Dice is the leading career destination for tech experts at every stage of their careers. Our client, Next Step Systems, is seeking the following. Apply via Dice today!

We are seeking an HPC Software Engineer to design, develop, test, deploy, document, maintain, and enhance complex and diverse software for HPC (High Performance Computing) systems based upon documented requirements. Critical for an HPC Software Engineer is either a very strong math background and/or a very strong computer hardware background. One or both is required for the HPC Software Engineer to be able to understand the intricacies of the HPC architecture that is being targeted by the software being developed, or to understand the complex mathematical principles which underlie the software applications being developed. The HPC systems might include, but are not limited to, processing-intensive analytics, novel algorithm development, manipulation of extremely large data sets, real-time systems, and systems which incorporate data repositories, data transport services, and application and systems development and monitoring. Candidates must have an active TS/SCI with a Full Scope Polygraph security clearance. This is a 100% Onsite position and not open for Hybrid and/or Remote.

**HPC Software Engineer Responsibilities:**
...
**HPC Software Engineer Qualifications:**
- Must have an active TS/SCI Full Scope Polygraph security clearance.
- Experience with High Performance Computing (HPC).
- Must have a strong Math background and understand the complex mathematical principles.
- Experience with large Data Sets.
- Experience with Real Time systems.
- Experience with Open Source Software (OSS).
- Experience with Commercial Off-The-Shelf (COTS) or Government Off-The-Shelf (GOTS) software.
- Experience with Configuration Management and Web Services.

---

## 179. Senior Libraries Engineer -- AI and HPC - NVIDIA (Germany)
...
## 180. HPC - Senior Software Engineer - Kubernetes, Rust, Python - Erias Ventures
...
The Software Engineer shall be responsible for developing, sustaining, and troubleshooting GHOSTGEM's software suite of applications including DINO and possibly future capabilities as mission needs arise. Software development activities include implementation, testing, and integration with other COTS, GOTS, and FOSS products, packages, and libraries.
...
## 181. HPC Monitoring & Observability Engineer - Shield Consulting Solutions, Inc.

**Location:** Annapolis Junction, MD (Presencial)

**Salary Range:** $255,000 - $265,000
...
**Job Description**
- The Software Engineer shall be part of a team responsible for designing, developing and maintaining a comprehensive distributed Metrics and Monitoring solution for HPC systems to ensure the reliability, performance, and scalability of HPC infrastructure.
- In this position, the Software Engineer must be proficient with Splunk.
...
## 182. Senior HPC AI Cluster Engineer - NVIDIA (France)
...
## 183. HPC User Support Specialist - GRNET

**Location:** Atenas, Attica, Grécia (Híbrido)

GRNET S.A. provides Internet connectivity, high‑quality e‑Infrastructures and advanced services to the Greek Educational, Academic and Research community, aiming at minimizing the digital divide and ensuring equal participation of its members in the global Society of Knowledge. GRNET provides advanced services to the following sectors: Education, Research, Health, and Culture.

In early 2026, GRNET is expected to host the DAEDALUS supercomputer, ranked among the top 30 fastest supercomputers worldwide, and also serving the Greek AI factory - Pharos - with its demanding AI and data‑intensive workflows.

We are currently looking for a motivated HPC User Support Specialist to strengthen our team and provide high‑quality support to researchers, engineers, and scientific users running workloads on national HPC resources.

**Your Tasks**
- Respond to and resolve HPC user support tickets
- Assist users with job submission, scheduling, and workflow optimization
- Support users in accessing systems, storage, and HPC software environments
- Investigate and troubleshoot issues related to jobs, applications, and resource usage
- Help users improve the performance of their workloads, including profiling and basic code optimisation support
- Run and analyse application benchmarks and scaling tests to understand performance bottlenecks
- Contribute to onboarding, user guides, and technical documentation
- Participate in user training activities (webinars, tutorials, hands‑on sessions)
- Collaborate with system administrators to identify and resolve system-side issues impacting users
- Provide feedback for improving HPC services and user experience

**Your Profile**
- Experience using Linux environments and command-line tools
- Familiarity with HPC concepts such as modules, batch systems, job schedulers, and parallel computing
- Exposure to HPC job schedulers (preferably Slurm)
- Understanding of scientific computing workflows and common programming languages (e.g., Python, C/C++, Fortran, R)
- Experience with HPC application execution or user support in a technical environment
- Interest or experience in performance profiling (e.g., gprof, perf, Intel VTune, ARM MAP)
- Ability to troubleshoot issues involving jobs, user environments, or software modules
- Experience with ticketing or issue tracking tools (e.g., JIRA, Redmine, ServiceNow)
- Good knowledge of Greek and English

**Will be considered a plus**
- Hands‑on experience running workloads on HPC systems
- Familiarity with profiling and performance tuning tools
- Experience with containers for HPC (e.g., Apptainer/Singularity)
- Knowledge of parallel programming (MPI, OpenMP)
- Exposure to scientific domains (e.g., computational physics, AI/ML, bioinformatics)
- Experience preparing training material or teaching technical subjects
- MSc or PhD in a STEM field

---

## 184. HPC Domain Specialist (Climate/Weather) - A*STAR

**Location:** Cingapura, Cingapura (Presencial)

**About The Role**

Singapore top climate and weather experts are tackling one of the most critical challenges of our time. As our Climate Domain Specialist, you will be their essential partner the computational expert who empowers them to harness the massive power of the new supercomputer for their vital modelling. Your work is the critical link that translates their scientific goals into high-performance simulations, enabling the high-resolution modelling essential for our national climate resilience strategy. This is a rare opportunity to be the go-to HPC specialist for the nations climate research community, making a direct and lasting impact by scaling their work to new frontiers.
...
## 185. HPC Domain Specialist (Engineering, CFD) - A*STAR

**Location:** Cingapura, Cingapura (Presencial)

**About The Role**

Be the bridge between groundbreaking research and Singapore new supercomputer system. As our CFD Domain Specialist, you will be the national-level expert enabling key sectors like advanced manufacturing, aerospace, and urban sustainability. Your work will directly support researchers as they tackle Singapore most complex engineering challenges from designing more efficient industrial systems to modelling complex urban airflow. This is a unique role to be at the centre of the nation CFD research community, working at a scale that pushes the boundaries of the field.

**Responsibilities**
- Provide HPC and scientific domain advice to users of NSCC systems.
- Support and optimise large-scale Computational Fluid Dynamics (CFD) application workloads.
- Work with HPC performance engineers to profile and build performance models of the CFD applications and workflows.
- Engage and collaborate with new researchers, communities, and disciplines with computationally intensive requirements.
- Design, develop and implement HPC software best practices for CFD applications and workflows.
- Assist in the planning and design of future HPC systems, including benchmarking CFD workloads on various platforms and recommending the most suitable architecturemfor the research community.
- Develop HPC utilities and automated testing tools for NSCC HPC systems.
- Develop HPC user and best practice guides for NSCC HPC systems.
- Get up-to-date with scientific domain research development, HPC system and software technology.
...
- Experience in building CFD applications from source code.
- Good knowledge in CFD application performance optimisation and troubleshooting.
- Familiar with the working and using of CFD applications (e.g. OpenFOAM, Paraview) for research.
...
## 186. HPC Training Specialist - A*STAR
...
- Training Delivery: Organize and conduct hands-on HPC workshops, teaching best practices for job submission, parallel programming, and system utilization.
...
- Benchmarking & Analysis: Assist in analysing user proficiency gaps to refine training strategies.
...
- Developing open-source software and hardware projects for and with academia
...
**Key Responsibilities**
- Enabling the use of AI and High Performance Computing technologies in academia through regular on site engagement with universities and research institutions, based in the USA.
- Creating teaching materials, labs, design examples, demos, and application notes for use in on site and conference based training
- Delivering in person and remote technical training workshops to professors and graduate students at universities, conferences, and company hosted events
- Collaborating with faculty and students on research and teaching programs
- Supporting and representing the company at conferences, trade shows, and academic events
...
- Travel is a significant part of this role and may be approximately 25 to 50 percent, including domestic and occasional international travel.

**Preferred Experience**
- Experience in Data Science, AI/ML infrastructure or applications development including programming GPUs with HIP/CUDA or AI frameworks, such as PyTorch
- Familiarity with AMD High Performance Computing software and hardware development tools, and corresponding computer architecture concepts
- Experience developing and delivering training courses
- Experience with general software programming, development, and test processes
- Experience working in academic research/teaching setting, or alternatively, working as product, applications, or customer support engineer
- Strong oral and written communication, and excellent interpersonal skills: comfortable working with cross-functional, remote teams
- Strong problem-solving skills, being a self-starter capable of working with minimal supervision and leading new initiatives
- Demonstrated willingness and ability to travel frequently for on site university visits, conferences, and training delivery

**An Ideal Candidate Would Also Have**
- Experience with some/most/all of the following technologies:
  - AI: LLM, PyTorch, TensorFlow, JAX
  - Programming Language: C/C++, Python
  - Programming Model: HIP/ROCm/CUDA, MPI, OpenMP, BLAS
  - DevOps: Kubernetes, Slurm
- Involvement with open-source community
- Experience publishing and presenting technical papers at conferences

---

## 188. Junior HPC System Administrator - GRNET
...
We are currently looking for a passionate Junior HPC System Administrator to expand existing team capability on implementing and providing advanced operational support for systems.

As a Junior HPC System Administrator you will contribute to the high availability and smooth operation of the HPC systems. Your role will include monitoring, automation, troubleshooting and user support.

**Your tasks**
- Monitor system availability and respond to alerts
- Assist in automation of system configuration
- Troubleshoot issues with hardware, operating system and parallel file systems
- Respond to user support tickets
- Contribute to system documentation

**Your Profile**
- Experience in Linux administration (especially RHEL and RHEL clones) and Linux command-line tools
- Basic understanding of networking concepts (e.g., TCP/IP, DNS, firewalls)
- Experience with scripting languages (e.g., Bash, Python or Perl) for task automation
- Familiarity with configuration management tools (e.g., Ansible)
- Exposure to monitoring tools (e.g., Nagios, Ganglia, Prometheus, Grafana)
- Experience in the use of ticketing / issue tracking and project management systems (e.g. Atlassian JIRA, Redmine, etc.)
- Good knowledge of Greek and English language

**Will be considered a plus:**
- Basic understanding of HPC concepts, such as parallel computing and job scheduling
- Familiarity with job schedulers (e.g., SLURM, Torque) for managing compute workloads
- Exposure to HPC hardware components (e.g., GPUs, InfiniBand, parallel file systems like Lustre or GPFS)
- MSc or PhD in Computer Engineering or Computer Science
- 2-year experience in a relevant field (HPC environment)

---

## 189. Support Technician, HPC - Columbia University Irving Medical Center

**Location:** Nova York, NY (Presencial)
...
## 190. High-Performance Computing (HPC) (SA3) (Government) - AT&T

**Location:** Colúmbia, MD (Presencial)

**Salary Range:** $108,000 - $193,280
...
**Required Qualifications:**
B.S. in a technical discipline and 10 years' experience as a System Administrator in programs and contracts of similar scope, type and complexity or 15 years' experience in lieu of a degree.
- DoD 8570 IAT II level certification required.

---

## 191. Junior Project Manager R&D HPC - AT&S

**Location:** Leoben, Estíria, Áustria (Presencial)

Be part of our team!

AT&S is a leading global manufacturer of high-end IC substrates and printed circuit boards. AT&S industrializes leading-edge technologies for its core business segments Mobile Devices & Substrates, Automotive & Aerospace, Industrial and Medical and high-performance computing for AI applications.

To enhance our successful R&D Team at the Headquarters in Leoben, Austria, we are looking for a passionate

**Junior Project Manager R&D HPC**

In your role, you will support and drive R&D projects focused on innovative product concepts, product features, and manufacturing technologies within the field of modularization. You will work in an international environment, contributing to the development of new technologies, processes, materials, and intellectual property that strengthen AT&S' position as a technology leader.

**Your Responsibilities**
- Lead internal work packages, projects, and project teams in line with the AT&S Innovation Process (e.g. Stage Gate Process)
- Plan, coordinate, and execute technical requirements and equipment within assigned work packages
- Represent AT&S towards internal and external stakeholders such as customers, suppliers, partners, business units, and funding agencies
- Identify, plan, and drive customer-related product development projects
- Manage project budgets, timelines, and technical execution
- Monitor and screen new technologies, processes, and products relevant to R&D
- Support the protection and further development of intellectual property (IP)
- Motivate, coordinate, and support national and international project teams to ensure successful outcomes

**Your Profile**
- Graduate degree in physics, chemistry, mechatronics, electronics, communication or medical engineering, or a similar technical education
- Alternatively, an equivalent professional background with relevant industry experience
- Basic project management knowledge and understanding of structured development processes
- Fluent in spoken and written English
- Strong organizational, communication, moderation, and presentation skills
- Customer-oriented mindset with an entrepreneurial spirit
- Open-minded, proactive, and willing to work hands-on in a dynamic environment
- Willingness to travel internationally and continuously learn and develop professionally

---

## 192. Business Development Manager - HPC - Cornelis Networks

**Location:** San José, CA (Remoto)
...
Cornelis Networks delivers the world's highest performance scale-out networking solutions for AI and HPC datacenters. Our differentiated architecture seamlessly integrates hardware, software and system level technologies to maximize the efficiency of GPU, CPU and accelerator-based compute clusters at any scale.
...
## 193. HPC and AI Sales Specialist - Lenovo

**Location:** Carolina do Norte, Estados Unidos (Remoto)
...
Are you passionate about High Performance Computing (HPC) and AI? Join one of the fastest-growing HPC AI organizations and help solve some of the world's most complex challenges.

We are seeking a HPC and AI Sales Specialist to drive HPC and AI sales across strategic industries, including Financial Services, Neocloud/Scale out computing, and other key industries. This role is responsible for building strong customer relationships, developing new business opportunities, and delivering innovative, high-impact solutions to enterprise clients.

**What You'll Do**
- Build and manage a strong sales pipeline for HPC and AI solutions
- Identify, qualify, and close new business opportunities to meet and exceed revenue targets
...
- Drive vertical growth, particularly within Financial Services, Neocloud/Scale out computing, and other key industries
- Partner with internal teams, technical specialists, and channel partners to deliver end-to-end solutions
- Manage the full sales cycle from prospecting through deal closure and post-sales transition
- Ensure successful solution delivery aligned to customer expectations and objectives
...
- Collaborate cross-functionally to solve complex customer challenges and drive successful outcomes

**Basic Qualifications**
- Bachelor's degree in Engineering, Information Technology, Business, or related field (or equivalent experience)
...
- Ability to influence and engage executive and C-level decision makers
- Experience with consultative and solution-based selling approaches
...
- Experience working with partners, alliances, and channel ecosystems
- Strong negotiation, forecasting, and closing skills
- Self-motivated, results-driven, and able to operate independently
- Familiarity with GPU-based computing and accelerated workloads
...
The Cambridge HPC/AI Solutions Architect focuses on high performance compute, artificial intelligence, and enterprise solutions is a field-based technologist who consults with customers and builds advanced IT solutions in HPC/AI and enterprise for our customers. By partnering with the relationship sales managers, this individual will design, build, recommend, and sell the latest technologies in the market, apply Cambridge's unique business model, and leverage long-established relationships with a diverse group of technology manufacturers.

**Responsibilities And Duties**
- Determine customer needs, recommend the best platforms to solve challenges and employ multi-vendor solutions to both existing and net new clients with a focus on IT professionals.
- Prescribe solutions averaging +$1M annually to Education, Commercial, Federal Labs, Media & Entertainment, Cloud Service Providers, Research Computing, and Healthcare.
- Design cutting-edge and highly optimized solutions for HPC, AI, and ML across a variety of disciplines, with particular emphasis on: Multi-rack-scale compute clusters (hardware, management, scheduler), both x86 and ARM; data storage (parallel file systems, scale-out, software defined); secure containerized environments; high-throughput interconnects (Ethernet, Infiniband, OPIAI, CXL); GPU clusters; disaggregated composable infrastructure.
- Specific use-cases will include life sciences (genomic sequencing, bioinformatics, drug discovery); engineering (CFD, geoseismic); natural sciences; deep learning; IoT, and commercial analytics.
- Consult on enterprise information technology, including, without limitation, data storage (SAN, NAS, scale-out, object, archival, lifecycle management); data protection (backup and disaster recovery design); server and container virtualization (VMware, Redhat, Kubernetes); CPU and GPU compute; networking (core & edge), firewalls, VPNs and SSE; information security, and other enterprise data center technologies.
- Leverage deep knowledge of and relationships with tech industry leaders including AMD, DDN, Dell Technologies, Cisco, Cohesity, Commvault, HPe, IBM, Intel, Juniper, Lenovo, Microsoft, NVIDIA, Oracle, Redhat, VAST Data, VMWare, WEKA, and others.
- Drive specific demand generation activities with limited inside support. This includes prospecting, calling clients to attend technical lectures, and following up on marketing driving initiatives.
- Gain advanced expertise and earn certifications as assigned.
- Represent the company in face to face and on-line meetings, technical demonstrations, and conferences, with a high degree of competence and professionalism.
- Validate customer deliverables including quotes, proposals, and statements of work.
- Differentiate and add value to our solutions by leveraging our Professional Services team.
- Build long lasting relationships with vendors, clients, & IT Distributors.
- Work earnestly and respectfully with the cross-functional Cambridge team. A high level of respect for your peers and an eagerness to learn are required for your success.
- Engage regularly and frequently with Cambridge's internal tools as assigned, including but not limited to: CRM system, document management system, & company calendar.

**Qualifications**
- Candidates must have at least 10+ years of customer facing technical experience recommending high value workload solutions, research & development, life science compute, and data-center centric IT infrastructure solutions (data storage, data protection, compute, security, and networking) to IT professionals either for a vendor or technology reseller.
- Experience with specific technologies including high-performance computing clusters, high-throughput network solutions (Infiniband, OmniPath, 400GbE), schedulers (UGE, SGE, SLRUM, PGS, LSF), cluster management tools (Bright Computing, Werewolf and xCAT), and parallel file systems (Lustre, IBM, Spectrum Scale, mGPFS)
- Enterprise data storage technologies, such as SAN and NAS storage, Fibre Channel, iSCSI, CIFS, and NFS
- Windows Server and UNIX/Linux system administration
- Expertise developing accounts, writing technical proposals, giving presentations, and teaching employees / customers.
- Expert level knowledge of advanced computer hardware, software, and services.
- Existing relationships with technology vendors and distributors in the IT ecosystem.
...
- As this is a field-based role, the employee must be able to work remotely, independently, and unsupervised. Travel will be required 25% of the time.
- Candidates must have impeccable communication and presentation skills, an ability to multi-task, and high attention to detail. They must be able to negotiate, proactive in approach, effective problem solvers, organized, creative, intellectually curious, deal with ambiguity, earnings motivated, and able to work with different types of personalities.
- Authorization to work in the United States on a full-time basis required.

---

## 196. Solution Architect HPC and Container Platform - At Dawn Technologies

**Location:** Sofia, Sofia City, Bulgária (Presencial)

At AT DAWN Technologies, we are a fast-growing technology services company building high-impact teams across Data Engineering, AI, and Backend Development. Our clients include some of the most innovative product companies in the world. We operate delivery centers in India and Vietnam, enabling rapid, high-quality execution with a product mindset.
...
We are looking for a person with very strong technical skills and a proven track record of designing and working with container platforms such as Red Hat OpenShift, SUSE Rancher, CNCF Kubernetes, HPC Schedulers such as Slurm or PBS Pro, HPC/AI Cluster management technologies such as HPCM or BCM and the ability to work in a dynamic customer-focused team that requires excellent interpersonal skills.

**Key Responsibilities**

Candidate must have strong proficiency as a Solution Architect in at least three areas and proficiency in other areas.
...
- In-depth knowledge and hands-on experience with HPC technologies, workload schedulers -- Slurm, Altair PBS pro, and cluster managers -- HPCM, Bright cluster manager.
- In-depth knowledge and hands-on experience with containerization technologies like Docker, Singularity, or Podman.
- In-depth knowledge and hands-on experience with at least two of the container orchestration technologies like CNCF Kubernetes, Red Hat OpenShift, SUSE Rancher RKE/K3S, Canonical charmed kubernetes or HPE Ezmeral Runtime. Good to have
...
- Good knowledge of HPC networking stack (high speed networking), InfiniBand, Mellanox
- Good experience in performance optimization and health assessment of HPC components such as operating systems, storage, servers, parallel file systems, schedulers, and container orchestration platforms.
- Must be good in any of the programming or scripting languages like python, bash
- Good understanding of DNS, TCP/IP, Routing and Load Balancing.
- Knowledge of network protocols like TCP/IP, S3, FTP, NFS, or SMB/CIFS
- Familiarity with microservices architecture, CI/CD pipelines, and DevOps tools.
- Excellent problem-solving abilities, analytical thinking, and communication skills to interact with technical and non-technical stakeholders.
- Ability to lead technical projects by gathering the requirements, preparing the architecture / design and executing it end to end. Must be able to bring clarity and drive complex projects involving multiple stakeholders.
...
- Demonstrates a high-level understanding of all related vendor product roadmaps.
...
## 197. HPC Solution Architect - Coda Search│Staffing

**Location:** Dallas, TX (Presencial)

One of the fastest-growing companies in high performance compute is building a new Solutions Architecture group. And they are looking for a HPC Kubernetes Solution Architect who can help define what next-generation compute looks like.
...
## 198. HPC DC Lead Solution Architect - Viridien

**Location:** Houston, TX (Presencial)
...
We are seeking an experienced Lead HPC Solution Architect to join our Technical Projects Group. This role will lead the architecture, design, and delivery of HPC and cloud infrastructure solutions across our global platform, ensuring they are scalable, secure, and high-performing.

You'll combine deep Linux/HPC expertise with strong stakeholder engagement and execution skills, translating business needs into robust technical solutions. As a recognized SME, you'll advise senior leadership and engage directly with clients on key architecture decisions.
...
- Define and ensure non-functional requirements (performance, scalability, security, cost)
- Partner cross-functionally to deliver integrated, compliant solutions
- Guide delivery teams through implementation, risk, and issue resolution
- Lead automation and Infrastructure-as-Code initiatives to improve reliability and speed
- Ensure operational readiness (monitoring, SLAs, runbooks, etc.)
- Contribute to platform strategy, roadmap, and continuous improvement
...
- Represent the team in technical and leadership discussions

**What You Bring**
- Strong Linux experience within HPC environments, with progression into architecture/leadership
...
**Nice to Have:** Kubernetes, OpenStack, GPU platforms, parallel file systems, cloud/virtualization, or relevant certifications
...
## 199. Senior Solutions Architect - AI, HPC, & Lustre - NetApp

**Location:** Estados Unidos (Remoto)

**Salary Range:** $197,200 - $255,200

**Job Summary**

NetApp's Solutions Architecture (SA) team partners with Enterprise Sales to drive advanced AI, analytics, and high-performance computing (HPC) conversations with customers, stepping in when deep technical expertise is required beyond day-to-day SE support. As the Senior Solutions Architect for AI, Analytics & Lustre-based HPC Storage, you will support Enterprise customers across the United States, helping them design and scale AI/ML and data-intensive workloads that depend on ultra-high-performance storage architectures - whether deployed on-premises or across NeoCloud and AI hyperscaler GPU environments.

This role is uniquely focused on NetApp's high-performance storage solutions for Lustre, a parallel file system widely used in HPC and AI environments to deliver extreme throughput, low latency, and scalable access for GPU clusters and large-scale data processing.

**What You'll Do**

*Customer Engagement & AI / HPC Strategy*
- Lead advanced discussions with Enterprise customers around AI, analytics, and high-performance computing (HPC) architectures.
- Assess customer environments, focusing on data-intensive workloads, GPU clusters, and performance bottlenecks in storage pipelines.
- Identify opportunities where parallel file systems like Lustre can accelerate AI training, simulation workloads, and large-scale analytics.
- Present architectures spanning GenAI, distributed training pipelines, high-throughput data ingestion, and HPC workflows.
- Help customers architect and optimize HPC and AI storage solutions that bridge on-premises infrastructure with NeoCloud and AI hyperscaler GPU providers (e.g., CoreWeave, Lambda, Crusoe), ensuring high-performance data access regardless of where compute resides.

*Field Partnership & Enablement*
- Partner with Client Executives and SEs to align AI + HPC + storage strategy with account plans.
- Enable the field to identify and position opportunities involving:
  - GPU saturation challenges
  - AI training data pipelines
  - HPC simulation and research workloads
- Deliver workshops and technical sessions on AI infrastructure design, GPU/storage balance, and Lustre-based architectures.

*Technical Leadership (Lustre + AI Infrastructure Focus)*
- Architect high-performance AI and HPC storage solutions leveraging NetApp E-Series and Lustre.
- Provide Design Guidance:
  - Parallel file systems (Lustre architecture, metadata + object storage separation)
  - High-throughput networking (InfiniBand, RDMA, high-speed Ethernet)
  - GPU cluster integration (NVIDIA DGX, CUDA ecosystems)
  - Data pipelines optimized for large-scale distributed training
  - Storage connectivity and data movement strategies for NeoCloud and AI hyperscaler GPU environments
- Design systems that scale to petabyte-level datasets and extreme throughput requirements typical of AI and HPC.
- Support demos, benchmarks, POCs, and pilot environments demonstrating performance at scale and GPU efficiency gains.

**Who You Are**
- 7+ years in Solutions Architecture, pre-sales, or customer-facing technical roles with emphasis on AI/ML, HPC, or high-performance data platforms.

Hands-on experience with:
- Parallel file systems (Lustre strongly preferred) or other HPC storage architectures
- GPU-accelerated workloads (NVIDIA ecosystem, distributed training environments)
- AI/ML frameworks (PyTorch, TensorFlow, or similar)
- Data-intensive workloads such as simulation, modeling, large-scale analytics, or AI training pipelines

Core Technical Strengths:
- High-performance storage systems and architectures (block + parallel file systems)
- Data throughput optimization, I/O bottlenecks, and storage scaling strategies
- HPC infrastructure including compute, storage, and high-speed networking
- Knowledge of how parallel file systems enable simultaneous read/write access across distributed nodes, allowing throughput to scale linearly with cluster size.

---

## 200. Simcenter HPC- Product Architect - Siemens Digital Industries Software

**Location:** Pune, Maharashtra, Índia (Híbrido)

Siemens Digital Industries Software is a leading provider of solutions for the design, simulation, and manufacture of products across many different industries. Formula 1 cars, skyscrapers, ships, space exploration vehicles, and many of the objects we see in our daily lives are being conceived and manufactured using our Product Lifecycle Management (PLM) software.

**Position Overview**

Siemens is looking for a Product Architect for Simulation software Simcenter HPC to provide expert support and strategic optimization for enterprise simulation workloads within complex HPC and cloud environments. This role is central to ensuring application integration, maximizing performance, and resolving intricate system challenges across the full HPC stack. The incumbent will be a leader in reliability engineering, performing critical root cause analysis and managing escalations for our worldwide deployments.

This is a pivotal customer-facing role, responsible for guiding deployments, executing upgrades, and leading technical engagements. A comprehensive grasp of HPC hardware, cluster architecture, schedulers, and engineering applications is essential, alongside a proactive approach to automation, continuous improvement, and cross-functional collaboration to enhance system efficacy and achieve unparalleled customer satisfaction.

**Required Qualifications:**
- Bachelor's or Master's degree in Engineering, Computer Science, or related discipline
- 7--10 years of experience in HPC, simulation environments, or large-scale distributed systems

**Required Skillset**
- Advanced proficiency in Linux (RHEL or equivalent), including networking, security, and system internals. Preferred to have any relevant Linux certifications.
- Strong expertise in HPC architectures, including compute clusters, schedulers (PBS/Slurm/LSF), and workload management
- Experience with cloud-based HPC environments (OCI, AWS, Azure, or hybrid architectures)
- Deep understanding of hardware infrastructure: servers, GPUs/accelerators, InfiniBand/RDMA, MPI communication stacks and parallel storage systems
- Understanding of simulation workflows (pre/post-processing, solvers, co-simulation, DoE)
- Ability to analyze and isolate application vs infrastructure issues in simulation workloads
- Experience in performance tuning, benchmarking, and optimization of HPC workloads
- Proficiency in scripting (Python, Bash) and automation/tooling development
- Knowledge of containerization (Docker, Kubernetes) in HPC contexts
- Proficiency in automation and Infrastructure-as-Code (Ansible, Terraform/OpenTofu)
- Strong troubleshooting mindset with ability to handle complex escalations and customer-critical incidents

**Preferred Skillset**
- Experience with Simcenter HPC / HPCWorks ecosystem and Siemens simulation tools
- Experience with EDA or CAE workloads and industry-specific simulation use cases
- Hands-on experience with automation and DevOps tooling (CI/CD, SCM)
- Preferred to have any relevant Certifications to Linux, containers and orchestrations tools.
- Capability to build integrations, plugins, hooks, and application definitions for performance and functionality
...
**Salary Range (USA, VA, Herndon): $153,600.00 - $207,800.00 USD annually**
